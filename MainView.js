...
var Storage = require("FuseJS/Storage");
  ...
  function participateEvent(data){
              ...
              if (data.data.buttonImage.value === "Assets/Buttons/done.png" ) {
                data.data.buttonImage.value = "Assets/Buttons/participate.png";
              }else {
                data.data.buttonImage.value = "Assets/Buttons/done.png"
              }
  ...
  function joinClub(data){  
     ...
     if (data.data.joinImage.value === "Assets/Buttons/empty_heart.png" ) {
                data.data.joinImage.value = "Assets/Buttons/full_heart.png";
              }else {
                data.data.joinImage.value = "Assets/Buttons/empty_heart.png"
       }
    ...
    snapshot.forEach(function(childSnapshot){
      ...
      checkParticipationRef.once("value").then(function(partiSnapshot){
          if ( partiSnapshot.val() === null ){
            childData.buttonImage = Observable("Assets/Buttons/participate.png") ;
          }else {
            childData.buttonImage = Observable("Assets/Buttons/done.png") ;
          }
          ...
          checkJoinedClub.once("value").then(function(subSnapshot){
              if ( subSnapshot.val() === null ){
                childData.joinImage = Observable("Assets/Buttons/empty_heart.png") ;
              }else {
                childData.joinImage = Observable("Assets/Buttons/full_heart.png") ;
              }
              childData.club = {} ;
