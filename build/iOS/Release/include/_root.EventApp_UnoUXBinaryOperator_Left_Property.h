...
namespace g{struct EventApp_UnoUXBinaryOperator_Left_Property;}
...
struct EventApp_UnoUXBinaryOperator_Left_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Uno::UX::BinaryOperator*> _obj;

    void ctor_2(::g::Uno::UX::BinaryOperator* obj, ::g::Uno::UX::Selector name);
    static EventApp_UnoUXBinaryOperator_Left_Property* New1(::g::Uno::UX::BinaryOperator* obj, ::g::Uno::UX::Selector name);
};
// }
