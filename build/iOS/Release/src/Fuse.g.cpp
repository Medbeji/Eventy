...
void NodeGroupBase::AddContent()
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[50/*"AddContent ...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 4289, ::STRINGS[51/*"AddContent"*/]);
        return;
    }
    ...
    if (where == -1)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[52/*"Could not l...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 4308, ::STRINGS[51/*"AddContent"*/]);
        return;
    }
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[60] = uString::Const("C:\\Users\\nour\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\0.46.1\\$.uno");
...
Visual* Visual::LastVisualChild()
{
    ...
    for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[56/*Uno.Collections.ICollection<Fuse.Node>*/])); (i--) > 0; )
    {
        Visual* c = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[58/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret53), ret53), Visual_typeof());
