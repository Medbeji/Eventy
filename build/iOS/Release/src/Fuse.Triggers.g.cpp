...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Triggers\0.46.1\$.uno
// -------------------------------------------------------------------------
...
static void Busy_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\nour\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\0.46.1\\$.uno");
...
void Busy::UpdateState()
{
    ...
    if ((_rootOn & 1) == 1)
    {
        ...
        {
            _rootOn = (_rootOn & -2);
            ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"On='Paramet...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 203, ::STRINGS[7/*"UpdateState"*/]);
        }
        else
...
void Busy::activate(::g::Fuse::Scripting::Context* c, Busy* b, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[2/*"Busy.activa...*/], b, ::STRINGS[3/*"C:\\Users\\...*/], 264, ::STRINGS[0/*"activate"*/]);
        return;
    }
...
void Busy::deactivate(::g::Fuse::Scripting::Context* c, Busy* b, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"Busy.deacti...*/], b, ::STRINGS[3/*"C:\\Users\\...*/], 282, ::STRINGS[1/*"deactivate"*/]);
        return;
    }
...
void Completed::reset(::g::Fuse::Scripting::Context* c, Completed* cp, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"Completed.r...*/], cp, ::STRINGS[3/*"C:\\Users\\...*/], 824, ::STRINGS[10/*"reset"*/]);
        return;
    }
...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\0.46.1\triggers\$.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Triggers\0.46.1\actions\$.uno
// ---------------------------------------------------------------------------------
...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Elements\0.46.1\triggers\$.uno
// ----------------------------------------------------------------------------------
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[16/*"Double remo...*/], __this, ::STRINGS[3/*"C:\\Users\\...*/], 1729, ::STRINGS[17/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Unexpected ...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 1742, ::STRINGS[19/*"OnDone"*/]);
        return;
    }
...
static void Scrolled_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("C:\\Users\\nour\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\0.46.1\\triggers\\$.uno");
...
// public sealed class ScrollingAnimation :409
// {
...
static void ScrollingAnimation_build(uType* type)
{
    ...
    ::TYPES[28] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FindByType<Fuse.Controls.ScrollView>*/, ::g::Fuse::Controls::ScrollView_typeof(), NULL);
    type->SetInterfaces(
...
// protected override sealed void OnRooted() :514
void ScrollingAnimation__OnRooted_fn(ScrollingAnimation* __this)
{
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_scrollable = ((::g::Fuse::Controls::ScrollView*)uPtr(__this->Parent())->FindByType(::TYPES[28/*Fuse.Visual.FindByType<Fuse.Controls.ScrollView>*/]));
...
// protected override sealed void OnUnrooted() :527
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[30/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.State>*/], ::STRINGS[26/*"goto"*/], uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.State, object[]>*/], (void*)State__goto__fn), 2)));
}
...
void State::Goto()
{
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[27/*"Cannot call...*/], NULL, ::STRINGS[3/*"C:\\Users\\...*/], 2148, ::STRINGS[28/*"Goto"*/]);
        return;
    }
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 2, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[32/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.StateGroup>*/], ::STRINGS[26/*"goto"*/], uDelegate::New(::TYPES[33/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.StateGroup, object[]>*/], (void*)StateGroup__goto__fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[32/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.StateGroup>*/], ::STRINGS[29/*"gotoNext"*/], uDelegate::New(::TYPES[33/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.StateGroup, object[]>*/], (void*)StateGroup__gotoNext_fn), 2)));
}
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[30/*"StateGroup....*/], n, ::STRINGS[3/*"C:\\Users\\...*/], 1812, ::STRINGS[31/*"goto_"*/]);
        return;
    }
...
void StateGroup::gotoName(::g::Fuse::Scripting::Context* c, StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[32/*"Unable to f...*/], name), n, ::STRINGS[3/*"C:\\Users\\...*/], 1792, ::STRINGS[33/*"gotoName"*/]);
        return;
    }
...
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[44/*"Timeline.se...*/], n, ::STRINGS[3/*"C:\\Users\\...*/], 2502, ::STRINGS[40/*"playTo"*/]);
        return;
    }
...
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[44/*"Timeline.se...*/], n, ::STRINGS[3/*"C:\\Users\\...*/], 2551, ::STRINGS[42/*"seek"*/]);
        return;
    }
...
static void TransitionGroup_build(uType* type)
{
    ...
    ::STRINGS[46] = uString::Const("C:\\Users\\nour\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Navigation\\0.46.1\\$.uno");
...
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[45/*"Transition ...*/], t, ::STRINGS[46/*"C:\\Users\\...*/], 2649, ::STRINGS[47/*"Root"*/]);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[48/*"Transition ...*/], t, ::STRINGS[46/*"C:\\Users\\...*/], 2656, ::STRINGS[47/*"Root"*/]);
        return NULL;
    }
...
void Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[49/*"Trigger.OnP...*/], __this, ::STRINGS[3/*"C:\\Users\\...*/], 2848, ::STRINGS[50/*"Fuse.Animat...*/]);
        return;
    }
...
static void WhileKeyboardVisible_build(uType* type)
{
    ...
    ::TYPES[57] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Fuse::Platform::SystemUIWillResizeEventArgs_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
{
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    ::g::Fuse::Platform::SystemUI::add_BottomFrameWillResize(uDelegate::New(::TYPES[57/*Uno.EventHandler<Fuse.Platform.SystemUIWillResizeEventArgs>*/], (void*)WhileKeyboardVisible__OnBottomBarResize_fn, __this));
...
{
    ::g::Fuse::Platform::SystemUI::remove_BottomFrameWillResize(uDelegate::New(::TYPES[57/*Uno.EventHandler<Fuse.Platform.SystemUIWillResizeEventArgs>*/], (void*)WhileKeyboardVisible__OnBottomBarResize_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
void WhileKeyboardVisible::OnBottomBarResize(uObject* sender, ::g::Fuse::Platform::SystemUIWillResizeEventArgs* args)
{
    ...
    if (vp != NULL)
        density = ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(vp), ::TYPES[56/*Fuse.ICommonViewport*/]));
...
static void WhileValue_build(uType* type)
{
    ...
    ::TYPES[58] = ::g::Fuse::Triggers::IValue_typeof();
    ::TYPES[59] = ::g::Uno::UX::ValueChangedHandler_typeof();
    type->SetPrecalc(
    ...
    type->SetFields(30,
        ...
        ::TYPES[58/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::WhileValue, _obj), 0,
        ::TYPES[58/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::WhileValue, _source), 0,
        type->T(0), (uintptr_t)0, uFieldFlagsConstrained,
        ::TYPES[59/*Uno.UX.ValueChangedHandler`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::WhileValue, ValueChanged1), 0);
}
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[52/*"`Pulse` on ...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 4211, ::STRINGS[53/*"Pulse"*/]);
