...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Elements\0.46.1\triggers\actions\$.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Controls\0.46.1\triggers\$.uno
// ----------------------------------------------------------------------------------
...
{
    DebugAction* obj1 = (DebugAction*)uNew(DebugAction_typeof());
    obj1->ctor_2();
    return obj1;
}
// }
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("C:\\Users\\nour\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Navigation\\0.46.1\\$.uno");
    ::STRINGS[4] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"Requires a ...*/], __this, ::STRINGS[6/*"C:\\Users\\...*/], 283, ::STRINGS[4/*"Perform"*/]);
        return;
    }
