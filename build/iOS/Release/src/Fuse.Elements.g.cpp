...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Elements\0.46.1\$.uno
// -------------------------------------------------------------------------
...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Elements\0.46.1\caching\$.uno
// ---------------------------------------------------------------------------------
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[9/*"Draw called...*/], __this, ::STRINGS[6/*"C:\\Users\\...*/], 875, ::STRINGS[10/*"Draw"*/]);
...
// protected override sealed Fuse.VisualBounds get_HitTestChildrenBounds() :1239
...
// protected override sealed void PrependImplicitTransform(Fuse.FastMatrix m) :2393
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!flat && !_warnOpacityFlat)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[5/*"This elemen...*/], this, ::STRINGS[6/*"C:\\Users\\...*/], 1037, ::STRINGS[7/*"Composit"*/]);
    }
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[8/*"This elemen...*/], this, ::STRINGS[6/*"C:\\Users\\...*/], 1045, ::STRINGS[7/*"Composit"*/]);
    }
}
