...
// C:\Users\nour\AppData\Local\Fusetools\Packages\FuseCore\0.46.1\input\$.uno
// --------------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(s), ::TYPES[35/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[11/*"x"*/], (double)__this->WindowPoint().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[35/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[12/*"y"*/], (double)__this->WindowPoint().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddInt(uInterface(s, ::TYPES[35/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[13/*"index"*/], __this->PointIndex());
    ::g::Uno::Float2 localPoint = uPtr(__this->Visual())->WindowToLocal(__this->WindowPoint());
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[35/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[14/*"localX"*/], (double)localPoint.X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[35/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[15/*"localY"*/], (double)localPoint.Y);
}
