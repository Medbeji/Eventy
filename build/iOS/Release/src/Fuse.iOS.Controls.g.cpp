...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Controls.WebView\0.46.1\ios\$.uno
// -------------------------------------------------------------------------------------
...
void WebView__ctor_2_fn(WebView* __this, ::g::Fuse::Controls::WebView* webViewHost, ::g::ObjC::Object* wvHandle, uArray* schemes)
{
    __this->ctor_2(webViewHost, wvHandle, schemes);
}
...
void WebView__New1_fn(::g::Fuse::Controls::WebView* webViewHost, ::g::ObjC::Object* wvHandle, uArray* schemes, WebView** __retval)
{
    *__retval = WebView::New1(webViewHost, wvHandle, schemes);
}
...
void WebView::ctor_2(::g::Fuse::Controls::WebView* webViewHost, ::g::ObjC::Object* wvHandle, uArray* schemes)
{
    ctor_1(wvHandle);
...
WebView* WebView::Create(::g::Fuse::Controls::WebView* webViewHost, uArray* schemes)
{
    ...
    return WebView::New1(webViewHost, wv, schemes);
}

// private WebView New(Fuse.Controls.WebView webViewHost, ObjC.Object wvHandle, string[] schemes) [static] :195
WebView* WebView::New1(::g::Fuse::Controls::WebView* webViewHost, ::g::ObjC::Object* wvHandle, uArray* schemes)
{
    WebView* obj1 = (WebView*)uNew(WebView_typeof());
    obj1->ctor_2(webViewHost, wvHandle, schemes);
    return obj1;
}
// }
