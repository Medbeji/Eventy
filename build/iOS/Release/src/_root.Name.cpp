// This file was generated based on '.uno/ux11/Name.g.uno'.
...
void Name__InitializeUX_fn(Name* __this)
{
    __this->InitializeUX();
}
...
void Name::InitializeUX()
{
    ::g::Fuse::Font* temp = ::g::Fuse::Font::New2(::g::Uno::UX::BundleFileSource::New1(::g::EventApp_bundle::RobotoBoldc6aae36b()));
    FontSize(15.0f);
    Font(temp);
}
