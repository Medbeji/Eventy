...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\0.46.1\layouts\$.uno
// ----------------------------------------------------------------------------------------
...
void GridLayout::ModifyCount(uType* __type, uObject* list, int count, ::g::Fuse::Layouts::DefinitionBase* primordial)
{
    ...
    if (count < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"RowCount an...*/], this, ::STRINGS[6/*"C:\\Users\\...*/], 1116, ::STRINGS[7/*"ModifyCount"*/]);
        return;
    }
