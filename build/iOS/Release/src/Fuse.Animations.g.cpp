...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Animations\0.46.1\$.uno
// ---------------------------------------------------------------------------
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Resize star...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2733, ::STRINGS[13/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"Resize star...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2741, ::STRINGS[13/*".ctor"*/]);
        _valid = false;
        return;
    }
