...
// internal sealed class EventApp_FuseElementsElement_Opacity_Property :172
// {
static void EventApp_FuseElementsElement_Opacity_Property_build(uType* type)
{
    type->SetBase(::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float_typeof(), NULL));
    type->SetFields(1,
        ::g::Fuse::Elements::Element_typeof(), offsetof(::g::EventApp_FuseElementsElement_Opacity_Property, _obj), uFieldFlagsWeak);
}
...
::g::Uno::UX::Property1_type* EventApp_FuseElementsElement_Opacity_Property_typeof()
{
    ...
    type->fp_Get = (void(*)(::g::Uno::UX::Property1*, uTRef))EventApp_FuseElementsElement_Opacity_Property__Get_fn;
    ...
    type->fp_Set = (void(*)(::g::Uno::UX::Property1*, void*, uObject*))EventApp_FuseElementsElement_Opacity_Property__Set_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::Property*, bool*))EventApp_FuseElementsElement_Opacity_Property__get_SupportsOriginSetter_fn;
    return type;
}

// public EventApp_FuseElementsElement_Opacity_Property(Fuse.Elements.Element obj, Uno.UX.Selector name) :175
void EventApp_FuseElementsElement_Opacity_Property__ctor_2_fn(EventApp_FuseElementsElement_Opacity_Property* __this, ::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector* name)
{
    __this->ctor_2(obj, *name);
}

// public override sealed float Get() :177
void EventApp_FuseElementsElement_Opacity_Property__Get_fn(EventApp_FuseElementsElement_Opacity_Property* __this, float* __retval)
{
    return *__retval = uPtr(__this->_obj)->Opacity(), void();
}

// public EventApp_FuseElementsElement_Opacity_Property New(Fuse.Elements.Element obj, Uno.UX.Selector name) :175
...
// public override sealed void Set(float v, Uno.UX.IPropertyListener origin) :178
void EventApp_FuseElementsElement_Opacity_Property__Set_fn(EventApp_FuseElementsElement_Opacity_Property* __this, float* v, uObject* origin)
{
    float v_ = *v;
...
// public EventApp_FuseElementsElement_Opacity_Property(Fuse.Elements.Element obj, Uno.UX.Selector name) [instance] :175
void EventApp_FuseElementsElement_Opacity_Property::ctor_2(::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector name)
{
    ctor_1(name);
    _obj = obj;
}

// public EventApp_FuseElementsElement_Opacity_Property New(Fuse.Elements.Element obj, Uno.UX.Selector name) [static] :175
