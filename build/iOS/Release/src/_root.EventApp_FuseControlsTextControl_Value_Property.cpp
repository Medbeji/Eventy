...
// internal sealed class EventApp_FuseControlsTextControl_Value_Property :10
// {
static void EventApp_FuseControlsTextControl_Value_Property_build(uType* type)
{
    type->SetBase(::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL));
    type->SetFields(1,
        ::g::Fuse::Controls::TextControl_typeof(), offsetof(::g::EventApp_FuseControlsTextControl_Value_Property, _obj), uFieldFlagsWeak);
}
...
::g::Uno::UX::Property1_type* EventApp_FuseControlsTextControl_Value_Property_typeof()
{
    ...
    type->fp_Get = (void(*)(::g::Uno::UX::Property1*, uTRef))EventApp_FuseControlsTextControl_Value_Property__Get_fn;
    ...
    type->fp_Set = (void(*)(::g::Uno::UX::Property1*, void*, uObject*))EventApp_FuseControlsTextControl_Value_Property__Set_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::Property*, bool*))EventApp_FuseControlsTextControl_Value_Property__get_SupportsOriginSetter_fn;
    return type;
}

// public EventApp_FuseControlsTextControl_Value_Property(Fuse.Controls.TextControl obj, Uno.UX.Selector name) :13
void EventApp_FuseControlsTextControl_Value_Property__ctor_2_fn(EventApp_FuseControlsTextControl_Value_Property* __this, ::g::Fuse::Controls::TextControl* obj, ::g::Uno::UX::Selector* name)
{
    __this->ctor_2(obj, *name);
}

// public override sealed string Get() :15
void EventApp_FuseControlsTextControl_Value_Property__Get_fn(EventApp_FuseControlsTextControl_Value_Property* __this, uString** __retval)
{
    return *__retval = uPtr(__this->_obj)->Value(), void();
}

// public EventApp_FuseControlsTextControl_Value_Property New(Fuse.Controls.TextControl obj, Uno.UX.Selector name) :13
...
void EventApp_FuseControlsTextControl_Value_Property__Set_fn(EventApp_FuseControlsTextControl_Value_Property* __this, uString* v, uObject* origin)
{
...
// public EventApp_FuseControlsTextControl_Value_Property(Fuse.Controls.TextControl obj, Uno.UX.Selector name) [instance] :13
void EventApp_FuseControlsTextControl_Value_Property::ctor_2(::g::Fuse::Controls::TextControl* obj, ::g::Uno::UX::Selector name)
{
    ctor_1(name);
    _obj = obj;
}

// public EventApp_FuseControlsTextControl_Value_Property New(Fuse.Controls.TextControl obj, Uno.UX.Selector name) [static] :13
