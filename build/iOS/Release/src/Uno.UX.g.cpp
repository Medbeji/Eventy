...
// C:\Users\nour\AppData\Local\Fusetools\Packages\UnoCore\0.46.1\source\uno\ux\$.uno
// ---------------------------------------------------------------------------------
...
// protected override sealed void Push() :429
...
{
    ::STRINGS[12] = uString::Const("Divide");
    ::STRINGS[13] = uString::Const("EqualTo");
    ::STRINGS[14] = uString::Const("Multiply");
    ::STRINGS[15] = uString::Const(" does not support operator ");
...
{
    U_THROW(__this->NotSupported(::STRINGS[14/*"Multiply"*/]));
}
...
{
    return ::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(::g::Uno::Object::GetType(this))), ::STRINGS[15/*" does not s...*/]), op));
}
...
{
    ::STRINGS[16] = uString::Const("Unsupported vector of length ");
    ::STRINGS[8] = uString::Const(" (");
    ::STRINGS[9] = uString::Const(")");
    ::STRINGS[10] = uString::Const(", ");
...
::g::Uno::UX::Value* VectorValue::Compute(::g::Uno::UX::Value* v, uDelegate* op)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[16/*"Unsupported...*/], uBox<int>(::TYPES[18/*int*/], len))));
}
