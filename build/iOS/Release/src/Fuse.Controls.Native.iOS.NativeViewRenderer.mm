...
// internal sealed extern class NativeViewRenderer :1503
// {
...
// public NativeViewRenderer(ObjC.Object viewHandle) :1510
void NativeViewRenderer__ctor__fn(NativeViewRenderer* __this, ::g::ObjC::Object* viewHandle)
{
    __this->ctor_(viewHandle);
}

// private void DeleteTexture() :1620
void NativeViewRenderer__DeleteTexture_fn(NativeViewRenderer* __this)
{
    __this->DeleteTexture();
}

// private static void Draw(ObjC.Object viewHandle, int textureName, Uno.IntPtr pixelBufferHandle, int width, int height, float density, bool reuse) :1557
...
// private static void FreePixelBuffer(Uno.IntPtr buffer) :1661
void NativeViewRenderer__FreePixelBuffer_fn(void** buffer)
{
    NativeViewRenderer::FreePixelBuffer(*buffer);
}

// private void Fuse.Controls.Native.INativeViewRenderer.Draw(float4x4 localToClipTransform, float2 position, float2 size, float density) :1516
...
// private void Uno.IDisposable.Dispose() :1634
...
// public NativeViewRenderer(ObjC.Object viewHandle) [instance] :1510
...
// private void DeleteTexture() [instance] :1620
...
// private static void Draw(ObjC.Object viewHandle, int textureName, Uno.IntPtr pixelBufferHandle, int width, int height, float density, bool reuse) [static] :1557
...
// private static void FreePixelBuffer(Uno.IntPtr buffer) [static] :1661
void NativeViewRenderer::FreePixelBuffer(void* buffer)
{
    free( buffer );
}

// private static Uno.IntPtr MallocPixelBuffer(int size) [static] :1656
void* NativeViewRenderer::MallocPixelBuffer(int size)
{
    return malloc( size );
}

// public NativeViewRenderer New(ObjC.Object viewHandle) [static] :1510
