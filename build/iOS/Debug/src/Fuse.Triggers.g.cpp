...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[16/*"Double remo...*/], __this, ::STRINGS[3/*"/Users/medb...*/], 1742, ::STRINGS[17/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Unexpected ...*/], this, ::STRINGS[3/*"/Users/medb...*/], 1755, ::STRINGS[19/*"OnDone"*/]);
        return;
    }
...
static void Scrolled_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/1.0.2/triggers/$.uno");
...
void Scrolled__OnRooted_fn(Scrolled* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[23/*"Scrolled co...*/], __this, ::STRINGS[22/*"/Users/medb...*/], 288, ::STRINGS[24/*"OnRooted"*/], NULL);
        return;
    }
...
void Scrolled::check(::g::Fuse::Scripting::Context* c, Scrolled* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[21/*"check takes...*/], s, ::STRINGS[22/*"/Users/medb...*/], 242, ::STRINGS[20/*"check"*/], NULL);
        return;
    }
...
// public sealed class ScrollingAnimation :410
// {
// static ScrollingAnimation() :410
static void ScrollingAnimation__cctor_2_fn(uType* __type)
{
    ScrollingAnimation::_scrollPositionName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[25/*"ScrollPosit...*/]);
}

static void ScrollingAnimation_build(uType* type)
{
    ::STRINGS[25] = uString::Const("ScrollPosition");
    ::TYPES[29] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FindByType<Fuse.Controls.ScrollView>*/, ::g::Fuse::Controls::ScrollView_typeof(), NULL);
    type->SetInterfaces(
...
// protected override sealed void OnRooted() :509
...
// protected override sealed void OnUnrooted() :522
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[31/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.State>*/], ::STRINGS[26/*"goto"*/], uDelegate::New(::TYPES[32/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.State, object[]>*/], (void*)State__goto__fn), 2)));
}
...
void State::Goto()
{
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[27/*"Cannot call...*/], NULL, ::STRINGS[3/*"/Users/medb...*/], 2161, ::STRINGS[28/*"Goto"*/]);
        return;
    }
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 2, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[33/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.StateGroup>*/], ::STRINGS[26/*"goto"*/], uDelegate::New(::TYPES[34/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.StateGroup, object[]>*/], (void*)StateGroup__goto__fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[33/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.StateGroup>*/], ::STRINGS[29/*"gotoNext"*/], uDelegate::New(::TYPES[34/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.StateGroup, object[]>*/], (void*)StateGroup__gotoNext_fn), 2)));
}

static void StateGroup_build(uType* type)
{
    ::STRINGS[26] = uString::Const("goto");
    ::STRINGS[29] = uString::Const("gotoNext");
    ::STRINGS[30] = uString::Const("StateGroup.goto requires 1 argument");
    ::STRINGS[3] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Triggers/1.0.2/$.uno");
    ::STRINGS[31] = uString::Const("goto_");
    ::STRINGS[32] = uString::Const("Unable to find State with Name: ");
    ::STRINGS[33] = uString::Const("gotoName");
    ::TYPES[0] = ::g::Uno::Type_typeof();
    ::TYPES[1] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[30/*"StateGroup....*/], n, ::STRINGS[3/*"/Users/medb...*/], 1825, ::STRINGS[31/*"goto_"*/], NULL);
        return;
    }
...
void StateGroup::gotoName(::g::Fuse::Scripting::Context* c, StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[32/*"Unable to f...*/], name), n, ::STRINGS[3/*"/Users/medb...*/], 1805, ::STRINGS[33/*"gotoName"*/], NULL);
        return;
    }
...
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[44/*"Timeline.se...*/], n, ::STRINGS[3/*"/Users/medb...*/], 2587, ::STRINGS[40/*"playTo"*/], NULL);
        return;
    }
...
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[44/*"Timeline.se...*/], n, ::STRINGS[3/*"/Users/medb...*/], 2636, ::STRINGS[42/*"seek"*/], NULL);
        return;
    }
...
{
    ::STRINGS[45] = uString::Const("Transition must have a Navigator ancestor");
    ::STRINGS[46] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/1.0.2/$.uno");
    ::STRINGS[47] = uString::Const("Root");
    ::STRINGS[48] = uString::Const("Transition must have a Visual parent");
...
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[45/*"Transition ...*/], t, ::STRINGS[46/*"/Users/medb...*/], 2777, ::STRINGS[47/*"Root"*/], NULL);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[48/*"Transition ...*/], t, ::STRINGS[46/*"/Users/medb...*/], 2784, ::STRINGS[47/*"Root"*/], NULL);
        return NULL;
    }
...
{
    Trigger::ProgressName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[34/*"Progress"*/]);
}

static void Trigger_build(uType* type)
{
    ::STRINGS[34] = uString::Const("Progress");
    ::STRINGS[49] = uString::Const("Trigger.OnPlaybackdone called with _animState == null");
    ::STRINGS[3] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Triggers/1.0.2/$.uno");
    ::STRINGS[50] = uString::Const("Fuse.Animations.IBasePlayerFeedback.OnPlaybackDone");
    ::STRINGS[51] = uString::Const("Trigger started prior to being rooted: ");
    ::TYPES[10] = ::g::Uno::Action_typeof();
    ::TYPES[45] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof(), NULL);
...
void Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[49/*"Trigger.OnP...*/], __this, ::STRINGS[3/*"/Users/medb...*/], 2930, ::STRINGS[50/*"Fuse.Animat...*/]);
        return;
    }
...
void Trigger::Start()
{
    ...
    {
        if (!IsRootingStarted())
            U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[51/*"Trigger sta...*/], this)));
...
{
    ::TYPES[57] = ::g::Fuse::ICommonViewport_typeof();
    ::TYPES[58] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Fuse::Platform::SystemUIWillResizeEventArgs_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
{
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    ::g::Fuse::Platform::SystemUI::add_BottomFrameWillResize(uDelegate::New(::TYPES[58/*Uno.EventHandler<Fuse.Platform.SystemUIWillResizeEventArgs>*/], (void*)WhileKeyboardVisible__OnBottomBarResize_fn, __this));
...
{
    ::g::Fuse::Platform::SystemUI::remove_BottomFrameWillResize(uDelegate::New(::TYPES[58/*Uno.EventHandler<Fuse.Platform.SystemUIWillResizeEventArgs>*/], (void*)WhileKeyboardVisible__OnBottomBarResize_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
void WhileKeyboardVisible::OnBottomBarResize(uObject* sender, ::g::Fuse::Platform::SystemUIWillResizeEventArgs* args)
{
    ...
    if (vp != NULL)
        density = ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(vp), ::TYPES[57/*Fuse.ICommonViewport*/]));
...
{
    ::STRINGS[52] = uString::Const("`Pulse` on a `WhileValue` will be removed, create a `Timeline` instead.");
    ::STRINGS[3] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Triggers/1.0.2/$.uno");
    ::STRINGS[53] = uString::Const("Pulse");
    ::TYPES[59] = ::g::Fuse::Triggers::IValue_typeof();
    ::TYPES[60] = ::g::Uno::UX::ValueChangedHandler_typeof();
    type->SetPrecalc(
    ...
    type->SetFields(30,
        ...
        ::TYPES[59/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::WhileValue, _obj), 0,
        ::TYPES[59/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::WhileValue, _source), 0,
        type->T(0), (uintptr_t)0, uFieldFlagsConstrained,
        ::TYPES[60/*Uno.UX.ValueChangedHandler`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::WhileValue, ValueChanged1), 0);
}
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[52/*"`Pulse` on ...*/], this, ::STRINGS[3/*"/Users/medb...*/], 4300, ::STRINGS[53/*"Pulse"*/]);
