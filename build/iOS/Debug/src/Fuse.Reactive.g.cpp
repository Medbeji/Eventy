...
static void FunctionMirror__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/$.uno");
...
void FunctionMirror__CallClosure::Call()
{
    ...
    if (::g::Uno::String::op_Inequality(::g::Uno::UX::Selector__op_Implicit1(::g::Fuse::Reactive::IEventRecord::Sender(uInterface(uPtr(_e), ::TYPES[6/*Fuse.Reactive.IEventRecord*/]))), NULL))
        uPtr(obj)->Item(::STRINGS[4/*"sender"*/], uBox(::TYPES[32/*Uno.UX.Selector*/], ::g::Fuse::Reactive::IEventRecord::Sender(uInterface(uPtr(_e), ::TYPES[6/*Fuse.Reactive.IEventRecord*/]))));
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[5/*"JavaScript ...*/], ex, this, ::STRINGS[6/*"/Users/medb...*/], 207, ::STRINGS[7/*"Call"*/]);
        }
        else throw __t;
    }
}
...
{
    ::STRINGS[13] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/fusejs/$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[13/*"/Users/medb...*/], 135);
    return NULL;
}
...
void Console::Dir1(::g::Uno::Text::StringBuilder* builder, uObject* obj, int maxDepth, int indent)
{
    ...
    if (uIs(obj, ::TYPES[25/*Fuse.Scripting.Array*/]))
    {
        ...
        uPtr(builder)->AppendLine(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[20/*"Array["*/], uBox<int>(::TYPES[19/*int*/], uPtr(a)->Length())), ::STRINGS[21/*"]"*/]));
        ...
        if (indent <= maxDepth)
            ...
            {
                Console::Indent(builder, indent);
                uPtr(builder)->Append2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[18/*""*/], uBox<int>(::TYPES[19/*int*/], i)), ::STRINGS[19/*": "*/]));
...
void Console::Init(::g::Fuse::Scripting::Context* c)
{
    ...
    uPtr(console)->Item(::STRINGS[23/*"log"*/], uDelegate::New(::TYPES[26/*Fuse.Scripting.Callback*/], (void*)Console__Log_fn));
    console->Item(::STRINGS[24/*"dir"*/], uDelegate::New(::TYPES[26/*Fuse.Scripting.Callback*/], (void*)Console__Dir_fn));
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[14/*"null"*/], 1, ::STRINGS[13/*"/Users/medb...*/], 121);
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[33] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.0.2/$.uno");
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[33/*"/Users/medb...*/], 409, ::STRINGS[35/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
{
    uPtr(uPtr(c)->GlobalObject())->Item(::STRINGS[40/*"debug_log"*/], uDelegate::New(::TYPES[26/*Fuse.Scripting.Callback*/], (void*)DebugLog__Log_fn));
}
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[14/*"null"*/], 1, ::STRINGS[13/*"/Users/medb...*/], 99);
...
void GreaterOrEqual__Compute_fn(GreaterOrEqual* __this, uObject* left, uObject* right, uObject** __retval)
{
    ...
    return *__retval = uBox(::TYPES[22/*bool*/], uUnbox<bool>(::TYPES[22/*bool*/], ::g::Fuse::Marshal::GreaterThan(left, right)) || uUnbox<bool>(::TYPES[22/*bool*/], ::g::Fuse::Marshal::EqualTo(left, right))), void();
}
...
static void Instantiator_build(uType* type)
{
    ...
    ::TYPES[45] = ::g::Uno::Collections::List_typeof()->MakeType(Instantiator__WindowItem_typeof(), NULL);
    ::TYPES[46] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Node_typeof(), uObject_typeof(), NULL);
    ::TYPES[38] = ::g::Fuse::Node_typeof();
    ::TYPES[31] = ::g::Fuse::Reactive::IObservable_typeof();
    ::TYPES[47] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[38/*Fuse.Node*/], NULL);
    ::TYPES[48] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[8] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[49] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[50] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2/*IndexOf<Fuse.Node>*/, ::TYPES[38/*Fuse.Node*/], NULL);
    ::TYPES[51] = Instantiator__ObservableLink_typeof();
    ::TYPES[52] = Instantiator__CountItem_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[28] = ::g::Fuse::IArray_typeof();
    ::TYPES[53] = ::g::Fuse::IObject_typeof();
    ::TYPES[23] = ::g::Uno::String_typeof();
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[54] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[55] = ::g::Uno::Action1_typeof()->MakeType(::TYPES[38/*Fuse.Node*/], NULL);
    ::TYPES[56] = ::g::Uno::Collections::RootableList_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(12,
        ...
        ::TYPES[56/*Uno.Collections.RootableList<Uno.UX.Template>*/], offsetof(::g::Fuse::Reactive::Instantiator, _rootTemplates), 0,
        ...
        ::TYPES[45/*Uno.Collections.List<Fuse.Reactive.Instantiator.WindowItem>*/], offsetof(::g::Fuse::Reactive::Instantiator, _windowItems), 0,
...
void Instantiator__FuseNodeISubtreeDataProviderGetData_fn(Instantiator* __this, ::g::Fuse::Node* n, uObject** __retval)
{
    ...
    {
        Instantiator__ObservableLink* ol = uAs<Instantiator__ObservableLink*>(v, ::TYPES[51/*Fuse.Reactive.Instantiator.ObservableLink*/]);

        if (ol != NULL)
            return *__retval = uPtr(ol)->Data(), void();

        if (!uIs(v, ::TYPES[52/*Fuse.Reactive.Instantiator.CountItem*/]))
...
void Instantiator__OnRooted_fn(Instantiator* __this)
{
    ...
    if (__this->_rootTemplates != NULL)
        uPtr(__this->_rootTemplates)->Subscribe(uDelegate::New(::TYPES[54/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, __this), uDelegate::New(::TYPES[54/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, __this));
}
...
void Instantiator::ctor_3()
{
    ...
    _windowItems = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[45/*Uno.Collections.List<Fuse.Reactive.Instantiator.WindowItem>*/]));
...
void Instantiator::AddTemplate(uObject* data, ::g::Uno::UX::Template* f, ::g::Uno::Collections::List* newElements)
{
    ...
    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[47/*"Template co...*/], this, ::STRINGS[33/*"/Users/medb...*/], 1588, ::STRINGS[48/*"AddTemplate"*/]);
        return;
    }
...
void Instantiator::CompleteWindowItem(Instantiator__WindowItem* wi, int windowIndex)
{
    ...
    ::g::Uno::Collections::List* newElements = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[47/*Uno.Collections.List<Fuse.Node>*/]);
    ...
    if (!anyMatched)
    {
        ...
        for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Templates()), ::TYPES[48/*Uno.Collections.IEnumerable<Uno.UX.Template>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[8/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::UX::Template* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[49/*Uno.Collections.IEnumerator<Uno.UX.Template>*/]), &ret6), ret6);
    ...
    uPtr(Parent())->InsertNodes((::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::TYPES[50/*Uno.Collections.EnumerableExtensions.IndexOf<Fuse.Node>*/], uPtr(Parent())->Children(), lastNode, &ret7), ret7) + 1, uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[38/*Fuse.Node*/], NULL), (::g::Uno::Collections::List__GetEnumerator_fn(newElements, &ret8), ret8)));
...
{
    uObject* so = uAs<uObject*>(data, ::TYPES[53/*Fuse.IObject*/]);

    if ((so != NULL) && ::g::Uno::String::op_Inequality(_matchKey, NULL))
    {
        if (::g::Fuse::IObject::ContainsKey(uInterface(uPtr(so), ::TYPES[53/*Fuse.IObject*/]), _matchKey))
            return uAs<uString*>(::g::Fuse::IObject::Item(uInterface(uPtr(so), ::TYPES[53/*Fuse.IObject*/]), _matchKey), ::TYPES[23/*string*/]);
    }
...
void Instantiator::InsertNew(int dataIndex)
{
    ...
    else if (!_pendingNew)
    {
        if (Defer() == 2)
            ...
            ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)Instantiator__CompleteWindowItemsAction_fn, this), -1, 0);
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"Limit canno...*/], this, ::STRINGS[33/*"/Users/medb...*/], 1078, ::STRINGS[50/*"set_Limit"*/], NULL);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[51/*"Offset cann...*/], this, ::STRINGS[33/*"/Users/medb...*/], 1030, ::STRINGS[52/*"set_Offset"*/], NULL);
        value = 0;
    }
...
{
    uPtr(Parent())->BeginRemoveChild(n, uDelegate::New(::TYPES[55/*Uno.Action<Fuse.Node>*/], (void*)Instantiator__CompletedRemove_fn, this));
}
...
uObject* Instantiator::Templates()
{
    ...
    _rootTemplates = ((::g::Uno::Collections::RootableList*)::g::Uno::Collections::RootableList::New1(::TYPES[56/*Uno.Collections.RootableList<Uno.UX.Template>*/]));

    if (IsRootingCompleted())
        uPtr(_rootTemplates)->Subscribe(uDelegate::New(::TYPES[54/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, this), uDelegate::New(::TYPES[54/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, this));
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[54/*"JavaScript ...*/], FileName()), ::STRINGS[55/*" fixed!"*/]), this, ::STRINGS[6/*"/Users/medb...*/], 447, ::STRINGS[56/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                JavaScript::UserScriptError(::STRINGS[57/*"JavaScript ...*/], se, this, ::STRINGS[6/*"/Users/medb...*/], 463, ::STRINGS[56/*"EvaluateMod...*/]);
...
void JavaScript::UserScriptError(uString* msg, ::g::Fuse::Scripting::ScriptException* ex, uObject* obj, uString* filePath, int lineNumber, uString* memberName)
{
    ...
    msg = ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(msg, ::STRINGS[59/*" in "*/]), uPtr(ex)->FileName()), ::STRINGS[60/*" line "*/]), uBox<int>(::TYPES[19/*int*/], uPtr(ex)->LineNumber()));
...
void LessOrEqual__Compute_fn(LessOrEqual* __this, uObject* left, uObject* right, uObject** __retval)
{
    ...
    return *__retval = uBox(::TYPES[22/*bool*/], uUnbox<bool>(::TYPES[22/*bool*/], ::g::Fuse::Marshal::LessThan(left, right)) || uUnbox<bool>(::TYPES[22/*bool*/], ::g::Fuse::Marshal::EqualTo(left, right))), void();
}
...
void LogicalAnd__Compute_fn(LogicalAnd* __this, uObject* left, uObject* right, uObject** __retval)
{
    ...
    return *__retval = uBox(::TYPES[22/*bool*/], ::g::Fuse::Marshal::ToBool(left) && ::g::Fuse::Marshal::ToBool(right)), void();
}
...
{
    __this->ClearDiagnostic();
    uObject* io = uAs<uObject*>(obj, ::TYPES[53/*Fuse.IObject*/]);

    if ((io != NULL) && ::g::Fuse::IObject::ContainsKey(uInterface(uPtr(io), ::TYPES[53/*Fuse.IObject*/]), uPtr(__this->_member)->Name()))
        __this->PushNewData(::g::Fuse::IObject::Item(uInterface(uPtr(io), ::TYPES[53/*Fuse.IObject*/]), uPtr(__this->_member)->Name()));
    else
        __this->SetDiagnostic(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[26/*"'"*/], ::g::Uno::Object::ToString(uPtr(uPtr(__this->_member)->Operand()))), ::STRINGS[65/*"' does not ...*/]), uPtr(__this->_member)->Name()), ::STRINGS[26/*"'"*/]), (uObject*)__this->_member);
}
...
{
    ::STRINGS[66] = uString::Const(" (ScriptMethod)");
    ::STRINGS[67] = uString::Const("(function (cl, callback) { cl.prototype.");
    ::STRINGS[68] = uString::Const(" = function() { callback(this.external_object, Array.prototype.slice.call(arguments)); }})");
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[24] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[26] = ::g::Fuse::Scripting::Callback_typeof();
...
void ThreadWorker__MethodClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Reactive::ThreadWorker* worker)
{
    _m = m;
    _worker = worker;
    ::g::Fuse::Scripting::Function* factory = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(uPtr(m)->Name, ::STRINGS[66/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[67/*"(function (...*/], uPtr(m)->Name), ::STRINGS[68/*" = function...*/])), ::TYPES[24/*Fuse.Scripting.Function*/]);
...
void NotEqual__Compute_fn(NotEqual* __this, uObject* left, uObject* right, uObject** __retval)
{
    ...
    return *__retval = uBox(::TYPES[22/*bool*/], !uUnbox<bool>(::TYPES[22/*bool*/], ::g::Fuse::Marshal::EqualTo(left, right))), void();
}
...
void Observable::ctor_2(::g::Fuse::Reactive::ThreadWorker* worker, ::g::Fuse::Scripting::Object* obj, bool supressCallback)
{
    ...
    uPtr(obj)->CallMethod(::STRINGS[73/*"addSubscriber"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (::g::Fuse::Scripting::Function*)_observeChange, uBox(::TYPES[22/*bool*/], supressCallback)));
}
...
void ThreadWorker__PropertyClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptProperty* p, ::g::Fuse::Reactive::ThreadWorker* worker)
{
    ...
    ::g::Fuse::Scripting::Function* definer = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(p->Name, ::STRINGS[88/*" (ScriptPro...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[89/*"(function(c...*/], p->Name), ::STRINGS[90/*"', "*/]), ::STRINGS[27/*"{"*/]), ::STRINGS[91/*"get: functi...*/]), ::STRINGS[92/*"var obs = g...*/]), ::STRINGS[93/*"if ("*/]), rawField), ::STRINGS[94/*" != obs) {"*/]), rawField), ::STRINGS[95/*" = obs;"*/]), propField), ::STRINGS[96/*" = obs"*/]), p->Modifier), ::STRINGS[97/*";"*/]), ::STRINGS[28/*"}"*/]), ::STRINGS[98/*"return "*/]), propField), ::STRINGS[28/*"}"*/]), ::STRINGS[99/*"})"*/]), ::STRINGS[99/*"})"*/])), ::TYPES[24/*Fuse.Scripting.Function*/]);
...
void ResourceSubscription::OnChanged()
{
    ...
    if (uPtr(uPtr(_origin)->Parent())->TryGetResource(_key, uDelegate::New(::TYPES[69/*Uno.Predicate<object>*/], (void*)ResourceSubscription__Accept_fn, this), &resource))
        ...
        _diag = ::g::Fuse::Diagnostics::ReportTemporalUserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[100/*"{Resource "*/], _key), ::STRINGS[39/*"} not found...*/]), _origin);
}
...
static void RootableScriptModule_build(uType* type)
{
    ...
    ::TYPES[70] = ::g::Uno::Collections::IList_typeof()->MakeType(uObject_typeof(), NULL);
    type->SetInterfaces(
...
void RootableScriptModule__GenerateArgs_fn(RootableScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    while (nt != NULL)
    {
        ...
        {
            argsString = ::g::Uno::String::op_Addition2(argsString, ::g::Uno::String::op_Addition2(::STRINGS[101/*", "*/], uPtr(uPtr(nt)->Entries)->Strong<uString*>(i)));
            ::g::Uno::Collections::List__Add_fn(uPtr(args), uPtr(__this->_worker)->Unwrap((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nt->Objects()), ::TYPES[70/*Uno.Collections.IList<object>*/]), uCRef<int>(i), &ret3), ret3)));
        }
...
{
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[71] = ::g::Fuse::MarshalException_typeof();
    ::TYPES[5] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
...
void TernaryOperator__Subscription::OnNewOperands(uObject* first, uObject* second, uObject* third)
{
    ...
    {
        if (uIs(__t.Exception, ::TYPES[71/*Fuse.MarshalException*/]))
        {
...
static void UnaryOperator__Subscription_build(uType* type)
{
    ...
    ::TYPES[5] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
        ::TYPES[29/*Uno.IDisposable*/], offsetof(UnaryOperator__Subscription_type, interface0),
...
static void Observable__Subscription_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/$.uno");
    ::STRINGS[104] = uString::Const("SetExclusive");
    ::STRINGS[105] = uString::Const("setValueWithOrigin");
    ::STRINGS[106] = uString::Const("Failed to set Observable value");
    ::TYPES[2] = ::g::Fuse::Reactive::IObserver_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[28] = ::g::Fuse::IArray_typeof();
    ::TYPES[11] = ::g::Fuse::Scripting::ScriptException_typeof();
...
{
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[75/*"clear"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, uBox<int>(::TYPES[19/*int*/], _origin)));
}
...
void Observable__Subscription::ReplaceAllExclusive(uObject* newValues)
{
    ...
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[102/*"replaceAllW...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, sa, uBox<int>(::TYPES[19/*int*/], _origin)));
}
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[103/*"Unexpected ...*/], this, ::STRINGS[6/*"/Users/medb...*/], 646, ::STRINGS[104/*"SetExclusive"*/]);
        return;
    }

    try
    {
        uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[105/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (uObject*)uPtr(uPtr(_om)->_worker)->Unwrap(newValue), uBox<int>(::TYPES[19/*int*/], _origin)));
    }
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ::g::Fuse::Scripting::ScriptException* ex = (::g::Fuse::Scripting::ScriptException*)__t.Exception;
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[106/*"Failed to s...*/], ex, this, ::STRINGS[6/*"/Users/medb...*/], 661, ::STRINGS[104/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
...
{
    return *__retval = ::STRINGS[107/*"-"*/], void();
}
// }
...
{
    ::STRINGS[108] = uString::Const("Name table missing 'this' pointer");
    ::STRINGS[109] = uString::Const("this");
    ::TYPES[27] = ::g::Fuse::Reactive::IContext_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::ConstantExpression_type, interface0));
}
...
void This__GetValue_fn(This* __this, uObject* context, uObject** __retval)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::STRINGS[108/*"Name table ...*/]));
}
...
{
    return *__retval = ::STRINGS[109/*"this"*/], void();
}
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(uObject_typeof(), uArray::New(::TYPES[72/*Fuse.Scripting.ScriptMember[]*/], 0));
}

static void ThreadWorker_build(uType* type)
{
    ::STRINGS[110] = uString::Const("Skipped Exception");
    ::STRINGS[6] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/$.uno");
    ::STRINGS[111] = uString::Const("CheckAndThrow");
    ::STRINGS[112] = uString::Const("JavaScript data model contains circular references or is too deep. Some data may not display correctly.");
    ::STRINGS[113] = uString::Const("CreateMirror");
    ::STRINGS[114] = uString::Const("Cannot use object of type '");
    ::STRINGS[115] = uString::Const("' as 'this' in JavaScript module; must be 'IProperties' or 'App'");
    ::STRINGS[116] = uString::Const("external_object");
    ::STRINGS[117] = uString::Const(" (ScriptClass)");
    ::STRINGS[118] = uString::Const("(function(external_object) { this.external_object = external_object; })");
    ::STRINGS[119] = uString::Const("(set-superclass)");
    ::STRINGS[120] = uString::Const("(function(cl, superclass) { cl.prototype = new superclass(); cl.prototype.constructor = cl; })");
    ::STRINGS[32] = uString::Const(".");
    ::STRINGS[66] = uString::Const(" (ScriptMethod)");
    ::STRINGS[121] = uString::Const("(function(cl, Observable) { cl.prototype.");
    ::STRINGS[122] = uString::Const(" = ");
    ::STRINGS[123] = uString::Const("; })");
    ::STRINGS[124] = uString::Const("ThreadWorked failed");
    ::STRINGS[125] = uString::Const("Run");
    ::STRINGS[126] = uString::Const("Could not create script context");
    ::TYPES[30] = ::g::Uno::Type_typeof();
    ::TYPES[72] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[73] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Reactive::Observable__Operation_typeof(), NULL);
    ::TYPES[74] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Scripting::ScriptClass_typeof(), ::g::Fuse::Scripting::Function_typeof(), NULL);
    ::TYPES[75] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[76] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Exception_typeof(), NULL);
    ::TYPES[77] = ::g::Uno::Threading::ThreadStart_typeof();
    ::TYPES[25] = ::g::Fuse::Scripting::Array_typeof();
    ::TYPES[24] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[15] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[78] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Platform::ApplicationState_typeof(), NULL);
    ::TYPES[79] = ::g::Fuse::IProperties_typeof();
    ::TYPES[80] = ::g::Fuse::Reactive::ClassInstance_typeof();
    ::TYPES[60] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[81] = ::g::Fuse::Scripting::ScriptMethodInline_typeof();
    ::TYPES[82] = ::g::Fuse::Scripting::ScriptMethod_typeof();
    ::TYPES[83] = ::g::Fuse::Scripting::ScriptProperty_typeof();
    ::TYPES[33] = ::g::Uno::Exception_typeof();
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[23] = ::g::Uno::String_typeof();
    ::TYPES[84] = ::g::Fuse::IRaw_typeof();
    ::TYPES[85] = ::g::Uno::Float2_typeof();
    ::TYPES[86] = ::g::Uno::Float3_typeof();
    ::TYPES[87] = ::g::Uno::Float4_typeof();
    ::TYPES[88] = ::g::Uno::Int2_typeof();
    ::TYPES[89] = ::g::Uno::Int3_typeof();
    ::TYPES[90] = ::g::Uno::Int4_typeof();
    ::TYPES[20] = ::g::Uno::Float_typeof();
    ::TYPES[19] = ::g::Uno::Int_typeof();
    ::TYPES[91] = ::g::Uno::UInt_typeof();
    ...
    type->SetFields(0,
        ...
        ::TYPES[76/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _exceptionQueue), 0,
        ::g::Uno::Threading::ManualResetEvent_typeof(), offsetof(::g::Fuse::Reactive::ThreadWorker, _idle), 0,
        ::TYPES[73/*Uno.Collections.List<Fuse.Reactive.Observable.Operation>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _messages), 0,
        uObject_typeof(), offsetof(::g::Fuse::Reactive::ThreadWorker, _messagesMutex), 0,
        ::TYPES[75/*Uno.Threading.ConcurrentQueue<Uno.Action>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _queue), 0,
        ...
        ::TYPES[74/*Uno.Collections.Dictionary<Fuse.Scripting.ScriptClass, Fuse.Scripting.Function>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _registeredClasses), 0,
...
{
    _messages = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[73/*Uno.Collections.List<Fuse.Reactive.Observable.Operation>*/]));
    _messagesMutex = ::g::Uno::Object::New();
    _registeredClasses = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[74/*Uno.Collections.Dictionary<Fuse.Scripting.ScriptClass, Fuse.Scripting.Function>*/]));
    ...
    _queue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[75/*Uno.Threading.ConcurrentQueue<Uno.Action>*/]));
    _exceptionQueue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[76/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/]));
    _thread = ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[77/*Uno.Threading.ThreadStart*/], (void*)ThreadWorker__Run_fn, this));
    uPtr(_thread)->Start();
    uPtr(_ready)->WaitOne();
    uPtr(_ready)->Dispose();
}
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[110/*"Skipped Exc...*/], next, this, ::STRINGS[6/*"/Users/medb...*/], 1861, ::STRINGS[111/*"CheckAndThrow"*/]);
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[112/*"JavaScript ...*/], this, ::STRINGS[6/*"/Users/medb...*/], 1431, ::STRINGS[113/*"CreateMirror"*/]);
        return NULL;
    }
...
{
    ::g::Fuse::Platform::Lifecycle::remove_Terminating(uDelegate::New(::TYPES[78/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)ThreadWorker__OnTerminating_fn, this));
    uPtr(_terminate)->Set();
    uPtr(_thread)->Join();
...
{
    uObject* n = uAs<uObject*>(obj, ::TYPES[79/*Fuse.IProperties*/]);

    if (n != NULL)
    {
        ::g::Fuse::Reactive::ClassInstance* ni = uAs< ::g::Fuse::Reactive::ClassInstance*>(uPtr(::g::Fuse::IProperties::Properties(uInterface(uPtr(n), ::TYPES[79/*Fuse.IProperties*/])))->Get(_classInstanceProperty), ::TYPES[80/*Fuse.Reactive.ClassInstance*/]);

        if (ni == NULL)
        {
            ni = ::g::Fuse::Reactive::ClassInstance::New1(this, obj, rootTable);
            uPtr(::g::Fuse::IProperties::Properties(uInterface(uPtr(n), ::TYPES[79/*Fuse.IProperties*/])))->Set(_classInstanceProperty, ni);
        }

        return ni;
    }

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[114/*"Cannot use ...*/], ::g::Uno::Type::FullName(uPtr(::g::Uno::Object::GetType(uPtr(uPtr(rootTable)->This()))))), ::STRINGS[115/*"' as 'this'...*/])));
}
...
uObject* ThreadWorker::Reflect(uObject* obj)
{
    ...
    if (sobj != NULL)
    {
        if (uPtr(sobj)->ContainsKey(::STRINGS[116/*"external_ob...*/]))
        {
            ::g::Fuse::Scripting::External* ext = uAs< ::g::Fuse::Scripting::External*>(uPtr(sobj)->Item(::STRINGS[116/*"external_ob...*/]), ::TYPES[60/*Fuse.Scripting.External*/]);
...
{
    ::g::Fuse::Scripting::Function* cl = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[117/*" (ScriptCla...*/]), ::STRINGS[118/*"(function(e...*/]), ::TYPES[24/*Fuse.Scripting.Function*/]);
    ...
    if (sc->SuperType() != NULL)
    {
        ...
        if (_setSuperclass == NULL)
            _setSuperclass = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::STRINGS[119/*"(set-superc...*/], ::STRINGS[120/*"(function(c...*/]), ::TYPES[24/*Fuse.Scripting.Function*/]);
    ...
    {
        ::g::Fuse::Scripting::ScriptMethodInline* inlineMethod = uAs< ::g::Fuse::Scripting::ScriptMethodInline*>(uPtr(uPtr(sc)->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[81/*Fuse.Scripting.ScriptMethodInline*/]);

        if (inlineMethod != NULL)
        {
            ::g::Fuse::Scripting::Function* m = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[32/*"."*/]), uPtr(inlineMethod)->Name), ::STRINGS[66/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[121/*"(function(c...*/], uPtr(inlineMethod)->Name), ::STRINGS[122/*" = "*/]), uPtr(inlineMethod)->Code), ::STRINGS[123/*"; })"*/])), ::TYPES[24/*Fuse.Scripting.Function*/]);
            uPtr(m)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, cl, (::g::Fuse::Scripting::Function*)uPtr(Context())->Observable()));
            continue;
        }

        ::g::Fuse::Scripting::ScriptMethod* method = uAs< ::g::Fuse::Scripting::ScriptMethod*>(uPtr(sc->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[82/*Fuse.Scripting.ScriptMethod*/]);
        ...
        ::g::Fuse::Scripting::ScriptProperty* property = uAs< ::g::Fuse::Scripting::ScriptProperty*>(uPtr(sc->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[83/*Fuse.Scripting.ScriptProperty*/]);
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[124/*"ThreadWorke...*/], e, this, ::STRINGS[6/*"/Users/medb...*/], 1757, ::STRINGS[125/*"Run"*/]);
...
void ThreadWorker::RunInner()
{
...

    {
        ...
        if (ThreadWorker::_context() == NULL)
        {
            ...
            if (ThreadWorker::_context() == NULL)
                U_THROW(::g::Uno::Exception::New2(::STRINGS[126/*"Could not c...*/]));
    ...
    while (true)
    {
        ...
        if (!_subscribedForClosing)
        {
            ...
            {
                ::g::Fuse::Platform::Lifecycle::add_Terminating(uDelegate::New(::TYPES[78/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)ThreadWorker__OnTerminating_fn, this));
...
uObject* ThreadWorker::Unwrap(uObject* dc)
{
    if (dc == NULL)
        ...
        return dc;
    else if (uIs(dc, ::TYPES[84/*Fuse.IRaw*/]))
        return ::g::Fuse::IRaw::Raw(uInterface(uPtr((uObject*)dc), ::TYPES[84/*Fuse.IRaw*/]));
    else if (uIs(dc, ::TYPES[24/*Fuse.Scripting.Function*/]))
        return dc;
    else if (uIs(dc, ::TYPES[85/*float2*/]))
        return ToArray(uUnbox< ::g::Uno::Float2>(::TYPES[85/*float2*/], dc));
    else if (uIs(dc, ::TYPES[86/*float3*/]))
        return ToArray1(uUnbox< ::g::Uno::Float3>(::TYPES[86/*float3*/], dc));
    else if (uIs(dc, ::TYPES[87/*float4*/]))
        return ToArray2(uUnbox< ::g::Uno::Float4>(::TYPES[87/*float4*/], dc));
    else if (uIs(dc, ::TYPES[88/*int2*/]))
        return ToArray3(uUnbox< ::g::Uno::Int2>(::TYPES[88/*int2*/], dc));
    else if (uIs(dc, ::TYPES[89/*int3*/]))
        return ToArray4(uUnbox< ::g::Uno::Int3>(::TYPES[89/*int3*/], dc));
    else if (uIs(dc, ::TYPES[90/*int4*/]))
        return ToArray5(uUnbox< ::g::Uno::Int4>(::TYPES[90/*int4*/], dc));
...
{
    uObject* so = uAs<uObject*>(obj, ::TYPES[92/*Fuse.Scripting.IScriptObject*/]);

    if ((so != NULL) && (::g::Fuse::Scripting::IScriptObject::ScriptObject(uInterface(uPtr(so), ::TYPES[92/*Fuse.Scripting.IScriptObject*/])) != NULL))
        return ::g::Fuse::Scripting::IScriptObject::ScriptObject(uInterface(uPtr(so), ::TYPES[92/*Fuse.Scripting.IScriptObject*/]));
    ...
    if (so != NULL)
        ::g::Fuse::Scripting::IScriptObject::SetScriptObject(uInterface(uPtr(so), ::TYPES[92/*Fuse.Scripting.IScriptObject*/]), res, Context());
...
uObject* ThreadWorker::Wrap(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[91/*uint*/]))
        return uBox(::TYPES[21/*double*/], (double)uUnbox<uint32_t>(::TYPES[91/*uint*/], obj));
...
{
    ::TYPES[93] = ValueForwarder__IValueListener_typeof();
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Reactive::ValueObserver_type, interface0),
        ::g::Fuse::Reactive::IObserver_typeof(), offsetof(::g::Fuse::Reactive::ValueObserver_type, interface1));
    type->SetFields(2,
        ::TYPES[93/*Fuse.Reactive.ValueForwarder.IValueListener*/], offsetof(::g::Fuse::Reactive::ValueForwarder, _listener), 0);
}
...
{
    ValueForwarder__IValueListener::NewValue(uInterface(uPtr(__this->_listener), ::TYPES[93/*Fuse.Reactive.ValueForwarder.IValueListener*/]), newValue);
}
...
{
    return *__retval = uBox(::TYPES[86/*float3*/], ::g::Uno::Float3__New2(::g::Fuse::Marshal::ToFloat(first), ::g::Fuse::Marshal::ToFloat(second), ::g::Fuse::Marshal::ToFloat(third))), void();
}

// public override sealed string ToString() :1300
void Vector3__ToString_fn(Vector3* __this, uString** __retval)
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[9/*"("*/], __this->First()), ::STRINGS[101/*", "*/]), __this->Second()), ::STRINGS[101/*", "*/]), __this->Third()), ::STRINGS[12/*")"*/]), void();
}
// }
...
{
    return *__retval = uBox(::TYPES[87/*float4*/], ::g::Uno::Float4__New2(::g::Fuse::Marshal::ToFloat(first), ::g::Fuse::Marshal::ToFloat(second), ::g::Fuse::Marshal::ToFloat(third), ::g::Fuse::Marshal::ToFloat(fourth))), void();
}

// public override sealed string ToString() :1316
void Vector4__ToString_fn(Vector4* __this, uString** __retval)
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[9/*"("*/], __this->First()), ::STRINGS[101/*", "*/]), __this->Second()), ::STRINGS[101/*", "*/]), __this->Third()), ::STRINGS[101/*", "*/]), __this->Fourth()), ::STRINGS[12/*")"*/]), void();
}
// }
