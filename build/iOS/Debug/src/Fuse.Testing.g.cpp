...
{
    ::STRINGS[0] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Testing/1.0.2/$.uno");
...
{
    ::g::Uno::Testing::Assert::Fail(_message, ::STRINGS[0/*"/Users/medb...*/], 34, ::STRINGS[1/*"Fail"*/]);
}
