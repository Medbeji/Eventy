...
{
    ::STRINGS[12] = uString::Const("Capture requires lostCallback Action");
    ::STRINGS[13] = uString::Const("Capture requires identity object");
    ::STRINGS[14] = uString::Const("Capture requires visual");
    ::STRINGS[15] = uString::Const("Capture can only be done on rooted enabled node");
    ::STRINGS[6] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.2/input/$.uno");
    ::STRINGS[16] = uString::Const("ModifyCapture");
    ::STRINGS[17] = uString::Const("Cannot modify the Visual of a capture");
...
bool Pointer::ModifyCapture1(uObject* identity, ::g::Fuse::Visual* visual, uDelegate* lostCallback, int type, int pointIndex)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"Capture can...*/], NULL, ::STRINGS[6/*"/Users/medb...*/], 1526, ::STRINGS[16/*"ModifyCapture"*/]);
        return false;
    }
    ...
    if (c != NULL)
    {
        if (uPtr(c)->Visual() != visual)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"Cannot modi...*/], identity, ::STRINGS[6/*"/Users/medb...*/], 1537, ::STRINGS[16/*"ModifyCapture"*/]);
    }
    else
    {
...
static void PointerEventArgs_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("localX");
    ::STRINGS[22] = uString::Const("localY");
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(s), ::TYPES[32/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[18/*"x"*/], (double)__this->WindowPoint().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[32/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[19/*"y"*/], (double)__this->WindowPoint().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddInt(uInterface(s, ::TYPES[32/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[20/*"index"*/], __this->PointIndex());
    ::g::Uno::Float2 localPoint = uPtr(__this->Visual())->WindowToLocal(__this->WindowPoint());
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[32/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[21/*"localX"*/], (double)localPoint.X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[32/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[22/*"localY"*/], (double)localPoint.Y);
}
