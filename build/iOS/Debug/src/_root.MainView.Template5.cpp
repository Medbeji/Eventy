...
{
    MainView__Template5::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"search"*/]);
}

static void MainView__Template5_build(uType* type)
{
    ::STRINGS[0] = uString::Const("search");
    type->SetFields(2,
...
{
    ::g::Search* __self1 = ::g::Search::New4(uPtr(__this->__parent1)->router);
