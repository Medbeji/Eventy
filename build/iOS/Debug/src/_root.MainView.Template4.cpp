...
{
    MainView__Template4::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"detail"*/]);
}

static void MainView__Template4_build(uType* type)
{
    ::STRINGS[0] = uString::Const("detail");
    type->SetFields(2,
...
{
    ::g::DetailView* __self1 = ::g::DetailView::New5(uPtr(__this->__parent1)->router);
