...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/internal/$.uno");
...
void ImageContainer::ResampleMode(int value)
{
    ...
    {
        if (value == 2)
            ::g::Fuse::Diagnostics::Deprecated(::STRINGS[4/*"ResampleMod...*/], this, ::STRINGS[2/*"/Users/medb...*/], 295, ::STRINGS[5/*"set_Resampl...*/]);
...
void ImageContainer::UpdateSourceListen(bool forceOff)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[1/*"Switching l...*/], this, ::STRINGS[2/*"/Users/medb...*/], 179, ::STRINGS[3/*"UpdateSourc...*/]);
...
{
    ::g::Fuse::Resources::HttpImageSource* http = uAs< ::g::Fuse::Resources::HttpImageSource*>(Source(), ::TYPES[20/*Fuse.Resources.HttpImageSource*/]);
