...
static void Binding_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.2/$.uno");
...
{
    if (Parent() != NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[2/*"double Bind...*/], this, ::STRINGS[3/*"/Users/medb...*/], 477, ::STRINGS[4/*"Root"*/]);
...
{
    if (Parent() == NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"double Bind...*/], this, ::STRINGS[3/*"/Users/medb...*/], 486, ::STRINGS[6/*"Unroot"*/]);
...
// /Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Marshal/1.0.2/$.uno
// --------------------------------------------------------------------------------------
...
void DrawContext::CaptureRootbuffer()
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/medb...*/], 581, ::STRINGS[33/*"CaptureRoot...*/]);
...
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/medb...*/], 735, ::STRINGS[34/*"Clear"*/]);
}
...
void DrawContext::GLFramebuffer(uint32_t value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/medb...*/], 647, ::STRINGS[42/*"set_GLFrame...*/]);
}
...
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/medb...*/], 776, ::STRINGS[43/*"set_GLScissor"*/]);
}
...
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/medb...*/], 820, ::STRINGS[44/*"set_GLViewp...*/]);
}
...
void DrawContext::PopRenderTarget()
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/medb...*/], 697, ::STRINGS[35/*"PopRenderTa...*/]);
...
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/medb...*/], 676, ::STRINGS[36/*"PushRenderT...*/]);
    _renderTarget = rt;
...
void DrawContext::ReleaseRootbuffer()
{
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[37/*"Unpopped Sc...*/], this, ::STRINGS[3/*"/Users/medb...*/], 607, ::STRINGS[38/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[39/*"Unpopped Cu...*/], this, ::STRINGS[3/*"/Users/medb...*/], 611, ::STRINGS[38/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[40/*"Unpopped Vi...*/], this, ::STRINGS[3/*"/Users/medb...*/], 615, ::STRINGS[38/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[41/*"Unpopped Re...*/], this, ::STRINGS[3/*"/Users/medb...*/], 619, ::STRINGS[38/*"ReleaseRoot...*/]);
...
// /Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Common/1.0.2/resources/$.uno
// -----------------------------------------------------------------------------------------------
...
static void Marshal_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("'");
    ::STRINGS[69] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Marshal/1.0.2/$.uno");
...
bool Marshal::TryConvertTo(uType* t, uObject* o, uObject** res, uObject* diagnosticSource)
{
    ...
    if (diagnosticSource != NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[67/*"Cannot conv...*/], o), ::STRINGS[68/*"' to target...*/]), t), ::STRINGS[11/*"'"*/]), diagnosticSource, ::STRINGS[69/*"/Users/medb...*/], 654, ::STRINGS[70/*"TryConvertTo"*/], NULL);
...
static void Node__cctor__fn(uType* __type)
{
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[73/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::TYPES[74/*Fuse.Scripting.ScriptMethod<Fuse.Node>*/], ::STRINGS[72/*"_createWatc...*/], uDelegate::New(::TYPES[75/*Uno.Func<Fuse.Scripting.Context, Fuse.Node, object[], object>*/], (void*)Node___createWatcher_fn), 1), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[74/*Fuse.Scripting.ScriptMethod<Fuse.Node>*/], ::STRINGS[73/*"_destroyWat...*/], uDelegate::New(::TYPES[76/*Uno.Action<Fuse.Scripting.Context, Fuse.Node, object[]>*/], (void*)Node___destroyWatcher_fn), 1), (::g::Fuse::Scripting::ScriptMethodInline*)::g::Fuse::Scripting::ScriptMethodInline::New1(::STRINGS[74/*"findData"*/], 1, ::STRINGS[75/*"function(ke...*/])));
}
...
void Node__ToString_fn(Node* __this, uString** __retval)
{
    ...
    if (!__this->Name().IsNull())
        return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2((::g::Uno::Object__ToString_fn(__this, &ret12), ret12), ::STRINGS[80/*", Name: "*/]), __this->Name().ToString(::TYPES[89/*Uno.UX.Selector*/])), void();
    else
...
{
    VisitSubtree(uDelegate::New(::TYPES[4/*Uno.Action<Fuse.Node>*/], (void*)Node__IterPreserveRootFrame_fn, this));
}
...
void NodeGroupBase::AddContent()
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[82/*"AddContent ...*/], this, ::STRINGS[3/*"/Users/medb...*/], 3223, ::STRINGS[83/*"AddContent"*/]);
        return;
    }
    ...
    if (where == -1)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[84/*"Could not l...*/], this, ::STRINGS[3/*"/Users/medb...*/], 3242, ::STRINGS[83/*"AddContent"*/]);
        return;
    }
...
// /Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.iOS/1.0.2/$.uno
// ----------------------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(serializer), ::TYPES[98/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[47/*"x"*/], (double)NewPosition().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[98/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[86/*"y"*/], (double)NewPosition().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[98/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[87/*"width"*/], (double)NewSize().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[98/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[88/*"height"*/], (double)NewSize().Y);
}
...
{
    ::STRINGS[89] = uString::Const("no Action found to remove");
...
void UpdateManager::RemoveAction(uObject* pu, int stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Listeners, NULL, pu))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[89/*"no Action f...*/]));
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[73/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[111/*Fuse.Scripting.ScriptMethod<Fuse.UserEvent>*/], ::STRINGS[90/*"raise"*/], uDelegate::New(::TYPES[112/*Uno.Action<Fuse.Scripting.Context, Fuse.UserEvent, object[]>*/], (void*)UserEvent__raise_fn), 2)));
}

static void UserEvent_build(uType* type)
{
    ::STRINGS[90] = uString::Const("raise");
    ::STRINGS[91] = uString::Const("UserEvent requires a Name");
    ::STRINGS[92] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/1.0.2/$.uno");
    ::STRINGS[93] = uString::Const("OnRooted");
    ::STRINGS[94] = uString::Const("Raise must be called with zero arguments, or one argument defining the arguments to the event");
    ::STRINGS[95] = uString::Const("Raise must be called with a JavaScript object to define name/value pairs");
    ::STRINGS[96] = uString::Const("Trying to Raise on unrooted UserEvent");
    ::STRINGS[97] = uString::Const("Raise");
    ::TYPES[26] = ::g::Uno::Type_typeof();
    ::TYPES[73] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[91/*"UserEvent r...*/], __this, ::STRINGS[92/*"/Users/medb...*/], 654, ::STRINGS[93/*"OnRooted"*/], NULL);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[96/*"Trying to R...*/], this, ::STRINGS[92/*"/Users/medb...*/], 701, ::STRINGS[97/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[94/*"Raise must ...*/], n, ::STRINGS[92/*"/Users/medb...*/], 421, ::STRINGS[90/*"raise"*/], NULL);
        return;
    }
    ...
    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[95/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[92/*"/Users/medb...*/], 428, ::STRINGS[90/*"raise"*/], NULL);
        return;
    }
...
void UserEventArgs__FuseScriptingIScriptEventSerialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[98/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[98/*"name"*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->Dispatch())->Name()));
...
static void Visual__cctor_1_fn(uType* __type)
{
    ...
    Visual::_isEnabledName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[99/*"IsEnabled"*/]);
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[73/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptProperty1*)::g::Fuse::Scripting::ScriptProperty1::New1(::TYPES[119/*Fuse.Scripting.ScriptProperty<Fuse.Visual, string>*/], ::STRINGS[85/*"Parameter"*/], uDelegate::New(::TYPES[120/*Uno.Func<Fuse.Visual, Uno.UX.Property<string>>*/], (void*)Visual__getParameterProperty_fn), ::STRINGS[100/*".notNull()....*/]), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[121/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[101/*"onParameter...*/], uDelegate::New(::TYPES[122/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__onParameterChanged_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[121/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[102/*"bringIntoView"*/], uDelegate::New(::TYPES[122/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__bringIntoView_fn), 2)));
}

static void Visual_build(uType* type)
{
    ::STRINGS[99] = uString::Const("IsEnabled");
    ::STRINGS[85] = uString::Const("Parameter");
    ::STRINGS[100] = uString::Const(".notNull().parseJson()");
    ::STRINGS[101] = uString::Const("onParameterChanged");
    ::STRINGS[102] = uString::Const("bringIntoView");
    ::STRINGS[103] = uString::Const("index");
    ::STRINGS[104] = uString::Const("Layout was invalidated while performing layout");
    ::STRINGS[105] = uString::Const("Invalid call to RearrangeMarginBox");
    ::TYPES[26] = ::g::Uno::Type_typeof();
    ::TYPES[73] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
...
void Visual::InsertNodes(int index, uObject* items)
{
    ...
    if ((index < 0) || (index > ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/]))))
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New6(::STRINGS[103/*"index"*/]));
...
void Visual::InvalidateLayout(int reason)
{
    if (Visual::_performingLayout())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[104/*"Layout was ...*/]));
...
Visual* Visual::LastVisualChild()
{
    ...
    for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); (i--) > 0; )
    {
        Visual* c = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret52), ret52), Visual_typeof());
...
{
    if (!HasMarginBox())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[105/*"Invalid cal...*/]));
...
{
    ::STRINGS[106] = uString::Const("Invalid RaiseType for event");
    ::STRINGS[3] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.2/$.uno");
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        ...
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[106/*"Invalid Rai...*/], 1, ::STRINGS[3/*"/Users/medb...*/], 1014);
            return;
        }
    }
...
{
    ::STRINGS[107] = uString::Const("visual");
    type->SetInterfaces(
...
void VisualEventArgs::ctor_1(::g::Fuse::Visual* visual)
{
    ...
    if (visual == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[107/*"visual"*/]));
...
{
    ::STRINGS[108] = uString::Const("Wrapped Exception");
    type->SetFields(3);
}
...
{
    ctor_2(::STRINGS[108/*"Wrapped Exc...*/], inner);
}
