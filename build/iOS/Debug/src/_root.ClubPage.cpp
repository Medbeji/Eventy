// This file was generated based on /Users/medbeji/Documents/event-app/event-app/.uno/ux11/ClubPage.g.uno.
...
{
    ClubPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 9, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"detailsImag...*/], ::STRINGS[2/*"detailsPlac...*/], ::STRINGS[3/*"detailsInfo...*/], ::STRINGS[4/*"detailsFact...*/], ::STRINGS[5/*"topBar"*/], ::STRINGS[6/*"temp_eb7"*/], ::STRINGS[7/*"citiesPageC...*/], ::STRINGS[8/*"sw"*/]);
...
static void ClubPage_build(uType* type)
{
    ...
    type->SetFields(107,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::ClubPage, temp_eb7), 0,
...
void ClubPage::InitializeUX()
{
    ...
    ::g::Fuse::Drawing::LinearGradient* temp22 = ::g::Fuse::Drawing::LinearGradient::New2();
    ::g::Fuse::Drawing::GradientStop* temp23 = ::g::Fuse::Drawing::GradientStop::New2();
    ::g::Fuse::Drawing::GradientStop* temp24 = ::g::Fuse::Drawing::GradientStop::New2();
    ::g::Fuse::Drawing::SolidColor* temp25 = ::g::Fuse::Drawing::SolidColor::New2();
    temp_eb7 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp4, __g_nametable1);
    ::g::Fuse::Animations::Move* temp26 = ::g::Fuse::Animations::Move::New2();
    ::g::Fuse::Reactive::DataBinding* temp27 = ::g::Fuse::Reactive::DataBinding::New1(temp_Value_inst, (uObject*)temp5, __g_nametable1, 3);
    ::g::Fuse::Controls::Panel* temp28 = ::g::Fuse::Controls::Panel::New3();
    citiesPageControl = ::g::Fuse::Controls::PageControl::New4();
    ::g::Fuse::Animations::Change* temp29 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[1/*Fuse.Animations.Change<bool>*/], sw_UserScroll_inst);
    ::g::Fuse::Reactive::DataBinding* temp30 = ::g::Fuse::Reactive::DataBinding::New1(temp1_Value_inst, (uObject*)temp6, __g_nametable1, 3);
    ::g::Fuse::Controls::StackPanel* temp31 = ::g::Fuse::Controls::StackPanel::New4();
    ::g::Fuse::Reactive::DataBinding* temp32 = ::g::Fuse::Reactive::DataBinding::New1(temp2_Value_inst, (uObject*)temp7, __g_nametable1, 2);
    ClubPage__Template* topItem = ClubPage__Template::New2(this, this);
    ::g::Fuse::Reactive::DataBinding* temp33 = ::g::Fuse::Reactive::DataBinding::New1(temp3_Items_inst, (uObject*)temp8, __g_nametable1, 3);
    temp9->LineNumber(3);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp10->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp28);
    temp11->Style(1);
    ...
    temp20->Alignment(2);
    temp20->Margin(::g::Uno::Float4__New2(0.0f, 13.0f, 0.0f, 0.0f));
    temp21->Color(::g::Fuse::Drawing::Colors::White());
    temp21->Alignment(1);
    temp21->Margin(::g::Uno::Float4__New2(5.0f, 5.0f, 5.0f, 5.0f));
    ::g::Fuse::Gestures::Clicked::AddHandler(temp21, uDelegate::New(::TYPES[4/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb7)));
    temp21->File(::g::Uno::UX::BundleFileSource::New1(::g::EventApp_bundle::back76704e09()));
    temp21->Background(temp25);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp21->Bindings()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb7);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp22->Stops()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Drawing.GradientStop>*/]), temp23);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp22->Stops()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Drawing.GradientStop>*/]), temp24);
    temp23->Offset(0.0f);
    temp23->Color(::g::Uno::Float4__New2(0.6784314f, 0.8666667f, 0.6705883f, 1.0f));
    temp24->Offset(1.0f);
    temp24->Color(::g::Uno::Float4__New2(0.427451f, 0.7529412f, 0.8235294f, 1.0f));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Animators()), ::TYPES[6/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp26);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Bindings()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp27);
    temp26->Y(-1.0f);
    temp26->Duration(0.3);
    temp26->RelativeTo(::g::Fuse::TranslationModes::Size());
    ::g::Fuse::Controls::Grid::SetRow(temp28, 1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp28->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), citiesPageControl);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Animators()), ::TYPES[6/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp29);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Bindings()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp30);
    ::g::Fuse::Animations::Change__set_Value_fn(temp29, uCRef(true));
    uPtr(sw)->UserScroll(false);
    uPtr(sw)->ClipToBounds(false);
    uPtr(sw)->Name(ClubPage::__selector9());
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(sw)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp31);
    temp31->HitTestMode(6);
    temp31->Opacity(1.0f);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp31->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp2);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp31->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp3);
    temp2->MinCount(0);
    temp2->MaxCount(1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp2->Bindings()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp32);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp33);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__g_nametable1)->Objects()), ::TYPES[8/*Uno.Collections.ICollection<object>*/]), temp_eb7);
