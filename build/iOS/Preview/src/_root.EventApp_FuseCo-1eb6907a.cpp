...
// public EventApp_FuseControlsScrollViewBase_UserScroll_Property(Fuse.Controls.ScrollViewBase obj, Uno.UX.Selector name) :163
...
// public override sealed bool Get(Uno.UX.PropertyObject obj) :165
...
{
    uStackFrame __("EventApp_FuseControlsScrollViewBase_UserScroll_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Controls::ScrollViewBase*>(obj, ::TYPES[0/*Fuse.Controls.ScrollViewBase*/]))->UserScroll(), void();
}

// public EventApp_FuseControlsScrollViewBase_UserScroll_Property New(Fuse.Controls.ScrollViewBase obj, Uno.UX.Selector name) :163
...
// public override sealed void Set(Uno.UX.PropertyObject obj, bool v, Uno.UX.IPropertyListener origin) :166
...
{
    uStackFrame __("EventApp_FuseControlsScrollViewBase_UserScroll_Property", "Set(Uno.UX.PropertyObject,bool,Uno.UX.IPropertyListener)");
    bool v_ = *v;
    uPtr(uCast< ::g::Fuse::Controls::ScrollViewBase*>(obj, ::TYPES[0/*Fuse.Controls.ScrollViewBase*/]))->UserScroll(v_);
}

// public EventApp_FuseControlsScrollViewBase_UserScroll_Property(Fuse.Controls.ScrollViewBase obj, Uno.UX.Selector name) [instance] :163
...
// public EventApp_FuseControlsScrollViewBase_UserScroll_Property New(Fuse.Controls.ScrollViewBase obj, Uno.UX.Selector name) [static] :163
