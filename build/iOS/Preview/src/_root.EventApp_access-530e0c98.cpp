...
{
    uStackFrame __("EventApp_accessor_ExploreItem_Country", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("EventApp_accessor_ExploreItem_Country", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
