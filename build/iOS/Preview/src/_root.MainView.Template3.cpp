// This file was generated based on /Users/medbeji/Documents/event-app/event-app/build/iOS/Preview/cache/ux11/MainView.g.uno.
...
{
    MainView__Template3::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"club"*/]);
}

static void MainView__Template3_build(uType* type)
{
    ::STRINGS[0] = uString::Const("club");
    type->SetFields(2,
...
void MainView__Template3__New1_fn(MainView__Template3* __this, uObject** __retval)
{
    ...
    ::g::ClubPage* __self1 = ::g::ClubPage::New5(uPtr(__this->__parent1)->router);
