...
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Basic{::g::Fuse::Controls::Panel_type* BackButton_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Basic{::g::Fuse::Controls::Panel_type* Button_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Basic{::g::Fuse::Controls::Panel_type* NavigationBar_typeof();}}
