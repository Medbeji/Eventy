...
// internal sealed class EventApp_FuseElementsElement_Alignment_Property :76
// {
...
// public EventApp_FuseElementsElement_Alignment_Property(Fuse.Elements.Element obj, Uno.UX.Selector name) :79
...
// public override sealed Fuse.Elements.Alignment Get(Uno.UX.PropertyObject obj) :81
...
{
    uStackFrame __("EventApp_FuseElementsElement_Alignment_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Elements::Element*>(obj, ::TYPES[0/*Fuse.Elements.Element*/]))->Alignment(), void();
}

// public EventApp_FuseElementsElement_Alignment_Property New(Fuse.Elements.Element obj, Uno.UX.Selector name) :79
...
// public override sealed void Set(Uno.UX.PropertyObject obj, Fuse.Elements.Alignment v, Uno.UX.IPropertyListener origin) :82
...
{
    uStackFrame __("EventApp_FuseElementsElement_Alignment_Property", "Set(Uno.UX.PropertyObject,Fuse.Elements.Alignment,Uno.UX.IPropertyListener)");
    int v_ = *v;
    uPtr(uCast< ::g::Fuse::Elements::Element*>(obj, ::TYPES[0/*Fuse.Elements.Element*/]))->Alignment(v_);
}

// public EventApp_FuseElementsElement_Alignment_Property(Fuse.Elements.Element obj, Uno.UX.Selector name) [instance] :79
...
// public EventApp_FuseElementsElement_Alignment_Property New(Fuse.Elements.Element obj, Uno.UX.Selector name) [static] :79
