...
static void EventApp_ExploreItem_ForegroundColor_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*ExploreItem*/], offsetof(::g::EventApp_ExploreItem_ForegroundColor_Property, _obj), uFieldFlagsWeak);
}
...
::g::Uno::UX::Property1_type* EventApp_ExploreItem_ForegroundColor_Property_typeof()
{
    ...
    type->fp_Get1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, uTRef))EventApp_ExploreItem_ForegroundColor_Property__Get1_fn;
    ...
    type->fp_Set1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, void*, uObject*))EventApp_ExploreItem_ForegroundColor_Property__Set1_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::PropertyAccessor*, bool*))EventApp_ExploreItem_ForegroundColor_Property__get_SupportsOriginSetter_fn;
    return type;
}

// public EventApp_ExploreItem_ForegroundColor_Property(ExploreItem obj, Uno.UX.Selector name) :198
...
// public override sealed float4 Get(Uno.UX.PropertyObject obj) :200
...
{
    uStackFrame __("EventApp_ExploreItem_ForegroundColor_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::ExploreItem*>(obj, ::TYPES[0/*ExploreItem*/]))->ForegroundColor(), void();
}

// public EventApp_ExploreItem_ForegroundColor_Property New(ExploreItem obj, Uno.UX.Selector name) :198
...
// public override sealed Uno.UX.PropertyObject get_Object() :199
...
// public override sealed void Set(Uno.UX.PropertyObject obj, float4 v, Uno.UX.IPropertyListener origin) :201
...
{
    uStackFrame __("EventApp_ExploreItem_ForegroundColor_Property", "Set(Uno.UX.PropertyObject,float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
    uPtr(uCast< ::g::ExploreItem*>(obj, ::TYPES[0/*ExploreItem*/]))->SetForegroundColor(v_, origin);
}

// public override sealed bool get_SupportsOriginSetter() :202
...
// public EventApp_ExploreItem_ForegroundColor_Property(ExploreItem obj, Uno.UX.Selector name) [instance] :198
void EventApp_ExploreItem_ForegroundColor_Property::ctor_3(::g::ExploreItem* obj, ::g::Uno::UX::Selector name)
{
    ctor_2(name);
    _obj = obj;
}

// public EventApp_ExploreItem_ForegroundColor_Property New(ExploreItem obj, Uno.UX.Selector name) [static] :198
