...
// internal sealed class EventApp_FuseControlsImage_Url_Property :68
// {
...
// public EventApp_FuseControlsImage_Url_Property(Fuse.Controls.Image obj, Uno.UX.Selector name) :71
...
// public override sealed string Get(Uno.UX.PropertyObject obj) :73
...
{
    uStackFrame __("EventApp_FuseControlsImage_Url_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Controls::Image*>(obj, ::TYPES[0/*Fuse.Controls.Image*/]))->Url(), void();
}

// public EventApp_FuseControlsImage_Url_Property New(Fuse.Controls.Image obj, Uno.UX.Selector name) :71
...
// public override sealed void Set(Uno.UX.PropertyObject obj, string v, Uno.UX.IPropertyListener origin) :74
...
{
    uStackFrame __("EventApp_FuseControlsImage_Url_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
    uPtr(uCast< ::g::Fuse::Controls::Image*>(obj, ::TYPES[0/*Fuse.Controls.Image*/]))->Url(v);
}

// public EventApp_FuseControlsImage_Url_Property(Fuse.Controls.Image obj, Uno.UX.Selector name) [instance] :71
...
// public EventApp_FuseControlsImage_Url_Property New(Fuse.Controls.Image obj, Uno.UX.Selector name) [static] :71
