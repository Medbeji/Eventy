...
static void CoreTextFont_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Text/1.0.2/implementation/$.uno");
...
uArray* CoreTextFont::TryConvertRGBAToL8(uArray* buffer)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == 0, ::STRINGS[0/*"(buffer.Len...*/], ::STRINGS[1/*"/Users/medb...*/], 220, uArray::Init<uObject*>(::TYPES[0/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), 0)));
