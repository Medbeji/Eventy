...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Selection\0.46.1\$.uno
// --------------------------------------------------------------------------
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\Users\\nour\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\0.46.1\\$.uno");
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"Unable to l...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 954, ::STRINGS[32/*"Perform"*/]);
        return;
    }
