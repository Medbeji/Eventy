...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Gestures\0.46.1\$.uno
// -------------------------------------------------------------------------
...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Gestures\0.46.1\internal\$.uno
// ----------------------------------------------------------------------------------
...
void Scroller::OnLostCapture()
{
    if (IsRootingCompleted())
    {
        ...
        if (::g::Fuse::Motion::Simulation::BoundedRegion2D::IsUser(uInterface(uPtr(_region), ::TYPES[15/*Fuse.Motion.Simulation.BoundedRegion2D*/])))
            ::g::Fuse::Motion::Simulation::BoundedRegion2D::EndUser(uInterface(uPtr(_region), ::TYPES[15/*Fuse.Motion.Simulation.BoundedRegion2D*/]), ::g::Uno::Float2__New1(0.0f));
    }
}
...
void Scroller::OnPointerPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (_down == -1)
    {
        ...
        if (captured)
        {
            ...
            ::g::Fuse::Motion::Simulation::BoundedRegion2D::StartUser(uInterface(uPtr(_region), ::TYPES[15/*Fuse.Motion.Simulation.BoundedRegion2D*/]));
            ::g::Fuse::Motion::Simulation::MotionSimulation::set_Position_ex(uInterface(uPtr(_region), ::TYPES[16/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), uCRef(uPtr(_scrollable)->ScrollPosition()));
            CheckNeedUpdated(false);
        }
    }
...
void Scroller::OnPointerReleased(uObject* sender, ::g::Fuse::Input::PointerReleasedArgs* args)
{
    ...
    if (_down == uPtr(args)->PointIndex())
    {
        ...
        if (::g::Fuse::Motion::Simulation::BoundedRegion2D::IsUser(uInterface(uPtr(_region), ::TYPES[15/*Fuse.Motion.Simulation.BoundedRegion2D*/])))
        {
            ...
            ::g::Fuse::Motion::Simulation::BoundedRegion2D::EndUser(uInterface(uPtr(_region), ::TYPES[15/*Fuse.Motion.Simulation.BoundedRegion2D*/]), ::g::Uno::Float2__op_UnaryNegation(uPtr(_scrollable)->ConstrainExtents((::g::Fuse::Motion::Simulation::PointerVelocity__get_CurrentVelocity_fn(uPtr(_velocity), &ret3), ret3))));
        }
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:\\Users\\nour\\AppData\\Local\\Fusetools\\Packages\\Fuse.Gestures\\0.46.1\\$.uno");
