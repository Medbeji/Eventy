...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.Android\0.46.1\$.uno
// ------------------------------------------------------------------------
...
// protected void OnUpdate() [instance] :412
...
{
    if (Parent() != NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[2/*"double Bind...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 457, ::STRINGS[4/*"Root"*/]);
...
{
    if (Parent() == NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"double Bind...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 466, ::STRINGS[6/*"Unroot"*/]);
...
void DrawContext::CaptureRootbuffer()
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 953, ::STRINGS[23/*"CaptureRoot...*/]);
...
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 1101, ::STRINGS[24/*"Clear"*/]);
}
...
void DrawContext::GLFramebuffer(uint32_t value)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 1019, ::STRINGS[32/*"set_GLFrame...*/]);
}
...
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 1142, ::STRINGS[33/*"set_GLScissor"*/]);
}
...
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 1186, ::STRINGS[34/*"set_GLViewp...*/]);
}
...
void DrawContext::PopRenderTarget()
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 1063, ::STRINGS[25/*"PopRenderTa...*/]);
...
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 1048, ::STRINGS[26/*"PushRenderT...*/]);
    _renderTarget = rt;
...
void DrawContext::ReleaseRootbuffer()
{
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[27/*"Unpopped Sc...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 979, ::STRINGS[28/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[29/*"Unpopped Cu...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 983, ::STRINGS[28/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[30/*"Unpopped Vi...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 987, ::STRINGS[28/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[31/*"Unpopped Re...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 991, ::STRINGS[28/*"ReleaseRoot...*/]);
...
void GraphicsWorker::Run()
{
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            {
                ::g::Uno::Exception* e = __t.Exception;
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[41/*"GraphicsWor...*/], e, a, ::STRINGS[3/*"C:\\Users\\...*/], 2950, ::STRINGS[42/*"Run"*/]);
...
void GraphicsWorker::Start()
{
    ...
    GraphicsWorker::_thread() = ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[36/*Uno.Threading.ThreadStart*/], (void*)GraphicsWorker__Run_fn));
...
// C:\Users\nour\AppData\Local\Fusetools\Packages\FuseCore\0.46.1\resources\$.uno
// ------------------------------------------------------------------------------
...
void NodeGroupBase::AddContent()
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[53/*"AddContent ...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 4289, ::STRINGS[54/*"AddContent"*/]);
        return;
    }
    ...
    if (where == -1)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[55/*"Could not l...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 4308, ::STRINGS[54/*"AddContent"*/]);
        return;
    }
...
// C:\Users\nour\AppData\Local\Fusetools\Packages\Fuse.UserEvents\0.46.1\$.uno
// ---------------------------------------------------------------------------
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[63] = uString::Const("C:\\Users\\nour\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\0.46.1\\$.uno");
...
// internal bool CalcAreChildrenFlat() :6421
...
// internal Fuse.Visual.HitTestTransformMode get_HitTestTransform() :6031
...
// public void OnSubtreeDataContextChanged() :7799
...
// internal Fuse.FastMatrix get_ParentWorldTransformInternal() :7439
...
// internal bool CalcAreChildrenFlat() [instance] :6421
...
// internal Fuse.Visual.HitTestTransformMode get_HitTestTransform() [instance] :6031
...
Visual* Visual::LastVisualChild()
{
    ...
    {
        Visual* c = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[64/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret53), ret53), Visual_typeof());
...
// public void OnSubtreeDataContextChanged() [instance] :7799
...
// internal Fuse.FastMatrix get_ParentWorldTransformInternal() [instance] :7439
