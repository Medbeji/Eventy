...
{
    FuseControlsNative_bundle::Blitterbdb4a41b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[30/*"uniform vec...*/], ::STRINGS[31/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[8/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[9/*"d"*/], ::STRINGS[11/*"f"*/]));
}

static void FuseControlsNative_bundle_build(uType* type)
{
    ::STRINGS[30] = uString::Const("uniform vec2 c,b;uniform mat4 d;attribute vec2 a;varying vec2 e;void main(){e=a;gl_Position=d*vec4(c+(a*b),0.,1.);}");
...
static void FuseControlsVideo_bundle_build(uType* type)
{
    ...
    ::STRINGS[37] = uString::Const("uniform samplerExternalOES q;varying vec2 p;void main(){gl_FragColor=vec4(texture2D(q,p).xyz,1.);}");
    ::STRINGS[8] = uString::Const("a");
    ::STRINGS[6] = uString::Const("b");
    ::STRINGS[7] = uString::Const("c");
    ::STRINGS[9] = uString::Const("d");
    ...
    ::STRINGS[39] = uString::Const("uniform samplerExternalOES h;varying vec2 g;void main(){gl_FragColor=vec4(texture2D(h,g).xyz,1.);}");
    ::TYPES[0] = ::g::Uno::String_typeof()->Array();
    type->SetFields(0,
