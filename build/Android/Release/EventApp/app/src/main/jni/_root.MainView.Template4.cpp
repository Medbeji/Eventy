...
{
    MainView__Template4::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"securinets"*/]);
}

static void MainView__Template4_build(uType* type)
{
    ::STRINGS[0] = uString::Const("securinets");
    type->SetFields(2,
...
{
    ::g::Securinets* self = ::g::Securinets::New5(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"securinets"*/], false);
    __parent1 = parent;
