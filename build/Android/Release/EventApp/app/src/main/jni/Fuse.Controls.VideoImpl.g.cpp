...
void VideoVisual__FuseControlsVideoImplIVideoCallbacksOnError_fn(VideoVisual* __this, ::g::Uno::Exception* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(::STRINGS[3/*"Video error"*/], e, __this, ::STRINGS[4/*"C:\\Users\\...*/], 1077, ::STRINGS[5/*"Fuse.Contro...*/]);
}
...
{
    ::g::Fuse::Diagnostics::Unsupported(::STRINGS[7/*"IPlayback.P...*/], __this, ::STRINGS[4/*"C:\\Users\\...*/], 1125, ::STRINGS[8/*"Fuse.Trigge...*/]);
}
