...
static void LinearGradient_build(uType* type)
{
    ...
    ::TYPES[4] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(4/*OrderBy<Fuse.Drawing.GradientStop>*/, ::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    ...
    ::TYPES[6] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<Fuse.Drawing.GradientStop>*/, ::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    type->SetInterfaces(
