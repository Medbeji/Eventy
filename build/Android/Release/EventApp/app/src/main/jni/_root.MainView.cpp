...
static void MainView__cctor_1_fn(uType* __type)
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(::g::Basic::Resources::RobotoRegular(), ::STRINGS[77/*"RobotoRegular"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(::g::Basic::Resources::RobotoLight(), ::STRINGS[78/*"RobotoLight"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(::g::Basic::Resources::RobotoMedium(), ::STRINGS[79/*"RobotoMedium"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicCLine()), ::STRINGS[80/*"Basic.CLine"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicCFillFore()), ::STRINGS[81/*"Basic.CFill...*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicCEmptyFore()), ::STRINGS[82/*"Basic.CEmpt...*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicCShadow()), ::STRINGS[83/*"Basic.CShadow"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicC50()), ::STRINGS[84/*"Basic.C50"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicC100()), ::STRINGS[85/*"Basic.C100"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicC200()), ::STRINGS[86/*"Basic.C200"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicC300()), ::STRINGS[87/*"Basic.C300"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicC400()), ::STRINGS[88/*"Basic.C400"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicC500()), ::STRINGS[89/*"Basic.C500"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicC600()), ::STRINGS[90/*"Basic.C600"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicC700()), ::STRINGS[91/*"Basic.C700"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicC800()), ::STRINGS[92/*"Basic.C800"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(uBox(::g::Uno::Float4_typeof(), ::g::Basic::Resources::BasicC900()), ::STRINGS[93/*"Basic.C900"*/]);
}
...
static void MainView_build(uType* type)
{
    ...
    ::STRINGS[77] = uString::Const("RobotoRegular");
    ::STRINGS[78] = uString::Const("RobotoLight");
    ::STRINGS[79] = uString::Const("RobotoMedium");
    ::STRINGS[80] = uString::Const("Basic.CLine");
    ::STRINGS[81] = uString::Const("Basic.CFillFore");
    ::STRINGS[82] = uString::Const("Basic.CEmptyFore");
    ::STRINGS[83] = uString::Const("Basic.CShadow");
    ::STRINGS[84] = uString::Const("Basic.C50");
    ::STRINGS[85] = uString::Const("Basic.C100");
    ::STRINGS[86] = uString::Const("Basic.C200");
    ::STRINGS[87] = uString::Const("Basic.C300");
    ::STRINGS[88] = uString::Const("Basic.C400");
    ::STRINGS[89] = uString::Const("Basic.C500");
    ::STRINGS[90] = uString::Const("Basic.C600");
    ::STRINGS[91] = uString::Const("Basic.C700");
    ::STRINGS[92] = uString::Const("Basic.C800");
    ::STRINGS[93] = uString::Const("Basic.C900");
    ::STRINGS[94] = uString::Const("login");
...
// private void InitializeUX() :231
void MainView__InitializeUX_fn(MainView* __this)
{
    __this->InitializeUX();
}

// public MainView New() :227
...
// private void InitializeUX() [instance] :231
void MainView::InitializeUX()
{
    ...
    MainView__Template4* securinets = MainView__Template4::New2(this, this);
    Background(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f));
    uPtr(router)->Name(MainView::__selector0());
    temp16->DefaultPath(::STRINGS[94/*"login"*/]);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp16->Templates()), ::TYPES[0/*Uno.Collections.ICollection<Uno.UX.Template>*/]), login);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp16->Templates()), ::TYPES[0/*Uno.Collections.ICollection<Uno.UX.Template>*/]), home);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp16->Templates()), ::TYPES[0/*Uno.Collections.ICollection<Uno.UX.Template>*/]), signUp);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp16->Templates()), ::TYPES[0/*Uno.Collections.ICollection<Uno.UX.Template>*/]), club);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp16->Templates()), ::TYPES[0/*Uno.Collections.ICollection<Uno.UX.Template>*/]), securinets);
...
// public MainView New() [static] :227
