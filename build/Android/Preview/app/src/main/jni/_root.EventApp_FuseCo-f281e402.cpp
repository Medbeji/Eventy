...
// public EventApp_FuseControlsImage_File_Property(Fuse.Controls.Image obj, Uno.UX.Selector name) :71
...
{
    uStackFrame __("EventApp_FuseControlsImage_File_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Controls::Image*>(obj, ::TYPES[0/*Fuse.Controls.Image*/]))->File(), void();
}

// public EventApp_FuseControlsImage_File_Property New(Fuse.Controls.Image obj, Uno.UX.Selector name) :71
...
{
    uStackFrame __("EventApp_FuseControlsImage_File_Property", "Set(Uno.UX.PropertyObject,Uno.UX.FileSource,Uno.UX.IPropertyListener)");
    uPtr(uCast< ::g::Fuse::Controls::Image*>(obj, ::TYPES[0/*Fuse.Controls.Image*/]))->File(v);
}

// public EventApp_FuseControlsImage_File_Property(Fuse.Controls.Image obj, Uno.UX.Selector name) [instance] :71
...
// public EventApp_FuseControlsImage_File_Property New(Fuse.Controls.Image obj, Uno.UX.Selector name) [static] :71
