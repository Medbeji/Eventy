...
static void EventApp_FuseTranslation_X_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*Fuse.Translation*/], offsetof(::g::EventApp_FuseTranslation_X_Property, _obj), uFieldFlagsWeak);
}
...
::g::Uno::UX::Property1_type* EventApp_FuseTranslation_X_Property_typeof()
{
    ...
    type->fp_Get1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, uTRef))EventApp_FuseTranslation_X_Property__Get1_fn;
    type->fp_get_Object = (void(*)(::g::Uno::UX::Property*, ::g::Uno::UX::PropertyObject**))EventApp_FuseTranslation_X_Property__get_Object_fn;
    type->fp_Set1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, void*, uObject*))EventApp_FuseTranslation_X_Property__Set1_fn;
    return type;
}

// public EventApp_FuseTranslation_X_Property(Fuse.Translation obj, Uno.UX.Selector name) :233
...
// public override sealed float Get(Uno.UX.PropertyObject obj) :235
...
{
    uStackFrame __("EventApp_FuseTranslation_X_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Translation*>(obj, ::TYPES[0/*Fuse.Translation*/]))->X(), void();
}

// public EventApp_FuseTranslation_X_Property New(Fuse.Translation obj, Uno.UX.Selector name) :233
...
// public override sealed void Set(Uno.UX.PropertyObject obj, float v, Uno.UX.IPropertyListener origin) :236
...
{
    uStackFrame __("EventApp_FuseTranslation_X_Property", "Set(Uno.UX.PropertyObject,float,Uno.UX.IPropertyListener)");
    float v_ = *v;
    uPtr(uCast< ::g::Fuse::Translation*>(obj, ::TYPES[0/*Fuse.Translation*/]))->X(v_);
}

// public EventApp_FuseTranslation_X_Property(Fuse.Translation obj, Uno.UX.Selector name) [instance] :233
void EventApp_FuseTranslation_X_Property::ctor_3(::g::Fuse::Translation* obj, ::g::Uno::UX::Selector name)
{
    ctor_2(name);
    _obj = obj;
}

// public EventApp_FuseTranslation_X_Property New(Fuse.Translation obj, Uno.UX.Selector name) [static] :233
