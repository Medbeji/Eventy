...
static void EventApp_ExploreItem_CardAlignment_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*ExploreItem*/], offsetof(::g::EventApp_ExploreItem_CardAlignment_Property, _obj), uFieldFlagsWeak);
}
...
::g::Uno::UX::Property1_type* EventApp_ExploreItem_CardAlignment_Property_typeof()
{
    ...
    type->fp_Get1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, uTRef))EventApp_ExploreItem_CardAlignment_Property__Get1_fn;
    ...
    type->fp_Set1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, void*, uObject*))EventApp_ExploreItem_CardAlignment_Property__Set1_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::PropertyAccessor*, bool*))EventApp_ExploreItem_CardAlignment_Property__get_SupportsOriginSetter_fn;
    return type;
}

// public EventApp_ExploreItem_CardAlignment_Property(ExploreItem obj, Uno.UX.Selector name) :207
...
// public override sealed Fuse.Elements.Alignment Get(Uno.UX.PropertyObject obj) :209
...
{
    uStackFrame __("EventApp_ExploreItem_CardAlignment_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::ExploreItem*>(obj, ::TYPES[0/*ExploreItem*/]))->CardAlignment(), void();
}

// public EventApp_ExploreItem_CardAlignment_Property New(ExploreItem obj, Uno.UX.Selector name) :207
...
// public override sealed Uno.UX.PropertyObject get_Object() :208
...
// public override sealed void Set(Uno.UX.PropertyObject obj, Fuse.Elements.Alignment v, Uno.UX.IPropertyListener origin) :210
...
{
    uStackFrame __("EventApp_ExploreItem_CardAlignment_Property", "Set(Uno.UX.PropertyObject,Fuse.Elements.Alignment,Uno.UX.IPropertyListener)");
    int v_ = *v;
    uPtr(uCast< ::g::ExploreItem*>(obj, ::TYPES[0/*ExploreItem*/]))->SetCardAlignment(v_, origin);
}

// public override sealed bool get_SupportsOriginSetter() :211
...
// public EventApp_ExploreItem_CardAlignment_Property(ExploreItem obj, Uno.UX.Selector name) [instance] :207
void EventApp_ExploreItem_CardAlignment_Property::ctor_3(::g::ExploreItem* obj, ::g::Uno::UX::Selector name)
{
    ctor_2(name);
    _obj = obj;
}

// public EventApp_ExploreItem_CardAlignment_Property New(ExploreItem obj, Uno.UX.Selector name) [static] :207
