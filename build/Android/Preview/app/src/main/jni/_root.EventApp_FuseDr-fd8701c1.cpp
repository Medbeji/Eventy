...
// internal sealed class EventApp_FuseDrawingImageFill_File_Property :51
// {
...
// public EventApp_FuseDrawingImageFill_File_Property(Fuse.Drawing.ImageFill obj, Uno.UX.Selector name) :54
...
{
    uStackFrame __("EventApp_FuseDrawingImageFill_File_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Drawing::ImageFill*>(obj, ::TYPES[0/*Fuse.Drawing.ImageFill*/]))->File(), void();
}

// public EventApp_FuseDrawingImageFill_File_Property New(Fuse.Drawing.ImageFill obj, Uno.UX.Selector name) :54
...
{
    uStackFrame __("EventApp_FuseDrawingImageFill_File_Property", "Set(Uno.UX.PropertyObject,Uno.UX.FileSource,Uno.UX.IPropertyListener)");
    uPtr(uCast< ::g::Fuse::Drawing::ImageFill*>(obj, ::TYPES[0/*Fuse.Drawing.ImageFill*/]))->File(v);
}

// public EventApp_FuseDrawingImageFill_File_Property(Fuse.Drawing.ImageFill obj, Uno.UX.Selector name) [instance] :54
...
// public EventApp_FuseDrawingImageFill_File_Property New(Fuse.Drawing.ImageFill obj, Uno.UX.Selector name) [static] :54
