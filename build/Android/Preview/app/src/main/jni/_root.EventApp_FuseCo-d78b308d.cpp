...
// internal sealed class EventApp_FuseControlsShape_Color_Property :92
// {
...
// public EventApp_FuseControlsShape_Color_Property(Fuse.Controls.Shape obj, Uno.UX.Selector name) :95
...
// public override sealed float4 Get(Uno.UX.PropertyObject obj) :97
...
{
    uStackFrame __("EventApp_FuseControlsShape_Color_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Controls::Shape*>(obj, ::TYPES[0/*Fuse.Controls.Shape*/]))->Color(), void();
}

// public EventApp_FuseControlsShape_Color_Property New(Fuse.Controls.Shape obj, Uno.UX.Selector name) :95
...
// public override sealed void Set(Uno.UX.PropertyObject obj, float4 v, Uno.UX.IPropertyListener origin) :98
...
{
    uStackFrame __("EventApp_FuseControlsShape_Color_Property", "Set(Uno.UX.PropertyObject,float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
...
// public EventApp_FuseControlsShape_Color_Property(Fuse.Controls.Shape obj, Uno.UX.Selector name) [instance] :95
...
// public EventApp_FuseControlsShape_Color_Property New(Fuse.Controls.Shape obj, Uno.UX.Selector name) [static] :95
