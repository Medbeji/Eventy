...
static void ExploreItem__Template2_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)ExploreItem__Template2__New2_fn, 0, true, type, 2, ::g::ExploreItem_typeof(), ::g::ExploreItem_typeof()));
}
...
{
    uStackFrame __("ExploreItem.Template2", "New()");
