...
// /Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.47.7/internal/$.uno
// -------------------------------------------------------------------------------------------------
...
static void Swiper_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/medbeji/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.47.7/internal/$.uno");
...
void Swiper__FuseInputIGestureOnCapture_fn(Swiper* __this, ::g::Fuse::Input::PointerEventArgs* args, int* how)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[3/*"invalid OnC...*/], NULL, ::STRINGS[1/*"/Users/medb...*/], 1088, ::STRINGS[4/*"Fuse.Input....*/]);
        return;
    }
...
void Swiper::CheckNeedUpdated(bool off)
{
    ...
    for (int i = 0; i < uPtr(_regions)->Count(); ++i)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[0/*"incomplete ...*/], this, ::STRINGS[1/*"/Users/medb...*/], 1010, ::STRINGS[2/*"CheckNeedUp...*/]);
...
bool SwipeRegion::SetProgress(double value, int flags)
{
    ...
    if (endProgress)
    {
        if (!((_progress == 1.0) || (_progress == 0.0)))
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[8/*"Unexpected ...*/], this, ::STRINGS[1/*"/Users/medb...*/], 748, ::STRINGS[9/*"SetProgress"*/]);
