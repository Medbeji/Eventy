...
public partial class ClubPage: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        var temp23 = new global::Fuse.Reactive.DataBinding(temp_Value_inst, temp5, __g_nametable, Fuse.Reactive.BindingMode.Default);
        var temp24 = new global::Fuse.Controls.Panel();
        citiesPageControl = new global::Fuse.Controls.PageControl();
        var temp25 = new global::Fuse.Animations.Change<bool>(sw_UserScroll_inst);
        var temp26 = new global::Fuse.Reactive.DataBinding(temp1_Value_inst, temp6, __g_nametable, Fuse.Reactive.BindingMode.Default);
        var temp27 = new global::Fuse.Controls.StackPanel();
        var temp28 = new global::Fuse.Reactive.DataBinding(temp2_Value_inst, temp7, __g_nametable, Fuse.Reactive.BindingMode.Write);
        var topItem = new Template(this, this);
        var temp29 = new global::Fuse.Reactive.DataBinding(temp3_Items_inst, temp8, __g_nametable, Fuse.Reactive.BindingMode.Default);
        temp9.LineNumber = 3;
        ...
        temp20.Margin = float4(35f, 0f, 35f, 0f);
        temp21.Alignment = Fuse.Elements.Alignment.Left;
        temp21.Margin = float4(5f, 30f, 0f, 0f);
        ...
        temp24.Children.Add(citiesPageControl);
