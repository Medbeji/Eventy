...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.40.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.227.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.1.4"), 12124)}, "C:\\Users\\nour\\Desktop\\event-app\\EventApp.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("EventApp");
}
}
}
