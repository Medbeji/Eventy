...
public partial class LoginPage: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        temp5.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../../../MainView.js"));
        ...
        global::Fuse.Gestures.Clicked.AddHandler(temp17, temp_eb6.OnEvent);
        temp17.Bindings.Add(temp_eb6);
        temp18.Text = " Sign Up";
        ...
        temp21.Margin = float4(120f, 30f, 0f, 0f);
