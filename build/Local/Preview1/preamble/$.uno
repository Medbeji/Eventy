...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.43.170"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124)}, "/Users/medbeji/Documents/event-app/event-app/EventApp.unoproj", GetBundle, new string[] { })
{
